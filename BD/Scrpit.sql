...
-- -----------------------------------------------------
-- Table `mydb`.`MaterialApoyo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`MaterialApoyo` (
  `idMaterialApoyo` INT NOT NULL AUTO_INCREMENT,
  `descripcion` VARCHAR(100) NOT NULL,
  `Grupo_idGrupo` INT NOT NULL,
  PRIMARY KEY (`idMaterialApoyo`),
  INDEX `fk_MaterialApoyo_Grupo1_idx` (`Grupo_idGrupo` ASC) VISIBLE,
  CONSTRAINT `fk_MaterialApoyo_Grupo1`
    FOREIGN KEY (`Grupo_idGrupo`)
    REFERENCES `mydb`.`Grupo` (`idGrupo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`Mensaje` (
  ...
  `Foro_idForo` INT NOT NULL,
  `Alumno_clave` VARCHAR(40) NOT NULL,
  `Docente_clave` VARCHAR(40) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Archivo` (
  ...
  `archivo` BLOB NOT NULL,
  `MaterialApoyo_idMaterialApoyo` INT NOT NULL,
  `Actividad_idActividad` INT NOT NULL,
  PRIMARY KEY (`idArchivo`, `Actividad_idActividad`),
  INDEX `fk_Archivo_MaterialApoyo1_idx` (`MaterialApoyo_idMaterialApoyo` ASC) VISIBLE,
  INDEX `fk_Archivo_Actividad1_idx` (`Actividad_idActividad` ASC) VISIBLE,
  CONSTRAINT `fk_Archivo_MaterialApoyo1`
    FOREIGN KEY (`MaterialApoyo_idMaterialApoyo`)
    REFERENCES `mydb`.`MaterialApoyo` (`idMaterialApoyo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
