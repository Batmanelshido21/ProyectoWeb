...
/**
   ...
   * @ignore
   */
var a=function t(e,i){t.superclass.constructor.call(this,e,i),this.setHoverDelay(t._HOVER_DELAY),this._diagram=i};t.Obj.createSubclass(a,t.CategoryRolloverHandler,"DvtDiagramCategoryRolloverHandler"),a._HOVER_DELAY=100,a.prototype.GetRolloverCallback=function(e,i,n,o){return t.Obj.createCallback(this,(function(){this.SetHighlightMode(!0),this._diagram.processEvent(e)}))},a.prototype.GetRolloutCallback=function(e,i,n,o){return t.Obj.createCallback(this,(function(){this.SetHighlightModeTimeout(),this._diagram.processEvent(e)}))};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var p=function(t){this.Init(t)};t.Obj.createSubclass(p,t.Automation,"DvtDiagramAutomation"),p.prototype.Init=function(t){this._diagram=t},p.prototype.GetSubIdForDomElement=function(t){var e=this._diagram.getEventManager().GetLogicalObject(t);return e&&e instanceof c?"node["+this._diagram.GetAllNodes().indexOf(e.getId())+"]":e&&e instanceof g?"link["+this._diagram.GetAllLinks().indexOf(e.getId())+"]":null},p.prototype.getDomElementForSubId=function(e){if(e==t.Automation.TOOLTIP_SUBID)return this.GetTooltipElement(this._diagram);var i=this._parseSubId(e),n=i.component,o=i.index,a=null;return"node"==n?a=this._getNode(o):"link"==n&&(a=this._getLink(o)),a?a.getElem():null},p.prototype._parseSubId=function(t){var e=t,i=-1,n=t.substring(0,t.indexOf("["));return n&&(e="node"==n||"link"==n?n:null,i=parseInt(t.substring(t.indexOf("[")+1,t.indexOf("]")))),{component:e,index:i}},p.prototype.getNodeCount=function(){return this._diagram.GetAllNodes().length},p.prototype.getLinkCount=function(){return this._diagram.GetAllLinks().length},p.prototype.getNode=function(e){var i=this._getNode(e);if(i){var n={};n.id=i.getId(),n.selected=i.isSelected(),n.tooltip=i.getShortDesc(),n.label=i.getData().label;var o=i.getData().backgroundStyle;return o&&o instanceof Object&&(o=t.CSSStyle.cssObjectToString(o)),n.background=o,n.icon=this._getMarkerData(i.GetIcon()),n.expanded=i.isDisclosed(),n}return null},p.prototype.getLink=function(e){var i=this._getLink(e);if(i){var n={};return n.id=i.getId(),n.selected=i.isSelected(),n.tooltip=i.getShortDesc(),n.label=i.getData().label,n.color=i.getLinkColor(),n.width=i.getLinkWidth(),n.style=this._getLinkStyleFromObject(i.getLinkStyle()),n.startNode=i.getStartId(),n.endNode=i.getEndId(),n.startConnectorType=i.getStartConnectorType(),n.endConnectorType=i.getEndConnectorType(),n.promoted=i.isPromoted(),i.isPromoted()&&(n.links=t.JsonUtils.clone(i.getData()._links)),n}return null},p.prototype.getPromotedLink=function(t,e){var i=this._getNode(t),n=this._getNode(e);if(!i||!n)return null;var o=g.GetPromotedLinkId(this._diagram,i.getId(),n.getId()),a=this._diagram.getLinkById(o);if(a){var s={};return s.id=a.getId(),s.selected=a.isSelected(),s.tooltip=a.getShortDesc(),s.color=a.getLinkColor(),s.width=a.getLinkWidth(),s.style=this._getLinkStyleFromObject(a.getLinkStyle()),s.startNode=a.getStartId(),s.endNode=a.getEndId(),s.startConnectorType=a.getStartConnectorType(),s.endConnectorType=a.getEndConnectorType(),s.count=a.getData()._links.length,s}return null},p.prototype._getLinkStyleFromObject=function(e){if(this._diagram.getCtx().isCustomElement())return t.CSSStyle.cssObjectToString(e);if(e&&e instanceof Object){if(e._type==g.CUSTOM_STYLE){var i=t.JsonUtils.clone(e);return delete i._type,t.CSSStyle.cssObjectToString(i)}return e._type}return e},p.prototype.getExpanded=function(){return this._diagram.DisclosedNodes},p.prototype._getMarkerData=function(e){if(e){var i={};return i.shape=e instanceof t.SimpleMarker?e.getType():"none",e.getFill()&&(i.color=e.getFill().getColor()),i}return null},p.prototype._getNode=function(t){var e=this._diagram.GetAllNodes();return t>=0&&t<e.length?this._diagram.getNodeById(e[t]):null},p.prototype._getLink=function(t){var e=this._diagram.GetAllLinks();return t>=0&&t<e.length?this._diagram.getLinkById(e[t]):null}}(dvt);
  return dvt;
});
