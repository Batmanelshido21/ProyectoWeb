...
/**
   ...
   * @ignore
   */
var e=new Object;t.Obj.createSubclass(e,t.Obj),e.VERSION_1={labelStyle:t.BaseComponentDefaults.FONT_FAMILY_ALTA_11+"color: #003286;",disabledLabelStyle:t.BaseComponentDefaults.FONT_FAMILY_ALTA_11,__labelGap:4,__labelSeparator:">"},e.calcOptions=function(i){var s=e._getDefaults(i);return i?t.JsonUtils.merge(i,s):s},e._getDefaults=function(i){return t.JsonUtils.clone(e.VERSION_1)},e.getGapSize=function(t,e){return Math.ceil(e*t.layout.gapRatio)};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var h=function(t,e,i,s,n){this.Init(i,s,n),this._node=t,this._id=e,this._bDrillable=!1};t.Obj.createSubclass(h,t.SimpleObjPeer),h.prototype.getId=function(){return this._id},h.prototype.isDrillable=function(){return this._bDrillable},h.prototype.setDrillable=function(t){this._bDrillable=t},h.prototype.handleMouseOver=function(){this._node&&this._node.handleMouseOver&&this._node.handleMouseOver()},h.prototype.handleMouseOut=function(){this._node&&this._node.handleMouseOut&&this._node.handleMouseOut()};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var u=function(t){this.Init(t)};t.Obj.createSubclass(u,t.KeyboardHandler),u.prototype.isSelectionEvent=function(t){return this.isNavigationEvent(t)&&!t.ctrlKey},u.prototype.isMultiSelectEvent=function(e){return e.keyCode==t.KeyboardEvent.SPACE&&e.ctrlKey};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var E=function(t){this.Init(),this._isHoriz=t};t.Obj.createSubclass(E,y),E.prototype.layout=function(t,e,i,s,n,o,a){var r=!a;this._layout(this._isHoriz,t,e,i,s,n,o,r)},E.prototype._layout=function(e,i,s,n,o,a,r,l){var h=i.getOptions(),_=this.setNodeBounds(s,n,o,a,r,l),d=s.getChildNodes();if(null!=d){var u,c=_.x,p=_.y,g=_.w,f=_.h,y=0;for(u=0;u<d.length;u++)y+=d[u].getSize()>0?d[u].getSize():0;for("on"==h.sorting&&(d=d.slice(0)).sort((function(t,e){return e.getSize()-t.getSize()})),e&&t.Agent.isRightToLeft(i.getCtx())&&(d=d.slice(0).reverse()),u=0;u<d.length;u++){var S=d[u];if(!(S.getSize()<=0)){var E=S.getSize()/y;e?g=_.w*E:f=_.h*E,this._layout(!e,i,S,c,p,g,f,!1),e?c+=g:p+=f}}}};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var v=function(t){this.Init(t)};t.Obj.createSubclass(v,u),v.prototype.isNavigationEvent=function(e){var i=v.superclass.isNavigationEvent.call(this,e);if(!i){var s=e.keyCode;s!=t.KeyboardEvent.OPEN_BRACKET&&s!=t.KeyboardEvent.CLOSE_BRACKET||(i=!0)}return i};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var C=function(t,e,i,s){r.call(this,t,e,i,s)};t.Obj.createSubclass(C,r),C.prototype.ProcessKeyboardEvent=function(e){var i=!0;if(e.keyCode==t.KeyboardEvent.ENTER&&e.ctrlKey){var s=this.getFocus();s.isIsolateEnabled()&&(s.__isIsolated()?s.__restoreNode():s.__isolateNode()),t.EventManager.consumeEvent(e)}else i=C.superclass.ProcessKeyboardEvent.call(this,e);return i};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var R=function t(e){this.Init({alta:t.SKIN_ALTA},e)};t.Obj.createSubclass(R,c),R.SKIN_ALTA={nodeDefaults:{borderColor:"rgba(255,255,255,0.3)",borderWidth:1,hoverColor:"#FFFFFF",labelDisplay:"auto",labelHalign:"center",selectedInnerColor:"#FFFFFF",selectedOuterColor:"#000000"},rootNodeContent:{},rotation:"on",expanded:"all",startAngle:90}}(dvt);
  return dvt;
});
