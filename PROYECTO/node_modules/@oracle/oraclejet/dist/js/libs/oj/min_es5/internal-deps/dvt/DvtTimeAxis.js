...
/**
   ...
   * @ignore
   */
var s=function t(e){this.Init({alta:t.VERSION_1},e)};t.Obj.createSubclass(s,t.BaseComponentDefaults),s.VERSION_1={backgroundColor:"rgba(255,255,255,0)",borderColor:"#d9dfe3",separatorColor:"#bcc7d2",labelStyle:new t.CSSStyle(t.BaseComponentDefaults.FONT_FAMILY_ALTA_12+"color: #333333;")};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var i=function(t,e,s){this.Init(t,e,s)};t.Obj.createSubclass(i,t.Obj),i.LONG=0,i.SHORT=1,i.prototype.Init=function(t,e,s){this._type=t,this._dateFormatStrings=e,this._locale=s,this._formats=[],this._formats[0]=new Object,this._formats[0].seconds="HH:MM:ss",this._formats[0].minutes="HH:MM",this._formats[0].hours="HH:MM",this._formats[0].days="dddd",this._formats[0].weeks="m/dd",this._formats[0].months="mmmm",this._formats[0].quarters="mmmm",this._formats[0].halfyears="yyyy",this._formats[0].years="yyyy",this._formats[0].twoyears="yyyy",this._formats[1]=new Object,this._formats[1].seconds="HH:MM:ss",this._formats[1].minutes="HH:MM",this._formats[1].hours="HH:MM",this._formats[1].days="m/dd",this._formats[1].weeks="m/dd",this._formats[1].months="mmm",this._formats[1].quarters="mmm",this._formats[1].halfyears="yy",this._formats[1].years="yy",this._formats[1].twoyears="yy"},i.prototype.setPattern=function(t,e){this._formats[this._type][t]=e},i.prototype.format=function(t,e,s){var i=this._formats[this._type][e];if(null!=i){var r=!1;if(s){for(var o=t.getTime(),n=Object.keys(s),a=0,h=0;h<n.length;h++)o>=parseInt(n[h],10)&&(a=s[n[h]]);t=new Date(o+a),r=!0}if(-1!=i.indexOf(":"))var c=":";else-1!=i.indexOf("/")&&(c="/");if(c){i=i.split(c);var l=this.getDateFormatValue(t,i[0],r);for(h=1;h<i.length;h++)l+=c+this.getDateFormatValue(t,i[h],r);return l}return this.getDateFormatValue(t,i,r)}try{return t.toLocaleString(this._locale)}catch(e){if("RangeError"===e.name)return t.toLocaleString()}return t.toLocaleString()},i.prototype.getDateFormatValue=function(t,e,s){if(s)switch(e){case"ss":var i=t.getUTCSeconds();return i<10?"0"+i:i;case"HH":return(i=t.getUTCHours())<10?"0"+i:i;case"MM":return(i=t.getUTCMinutes())<10?"0"+i:i;case"dd":return(i=t.getUTCDate())<10?"0"+i:i;case"dddd":return this._dateFormatStrings.dayNames[t.getUTCDay()+7];case"m":return t.getUTCMonth()+1;case"mmm":return this._dateFormatStrings.monthNames[t.getUTCMonth()];case"mmmm":return this._dateFormatStrings.monthNames[t.getUTCMonth()+12];case"yy":return t.getUTCFullYear().toString().substring(2,4);default:return t.getUTCFullYear()}else switch(e){case"ss":return(i=t.getSeconds())<10?"0"+i:i;case"HH":return(i=t.getHours())<10?"0"+i:i;case"MM":return(i=t.getMinutes())<10?"0"+i:i;case"dd":return(i=t.getDate())<10?"0"+i:i;case"dddd":return this._dateFormatStrings.dayNames[t.getDay()+7];case"m":return t.getMonth()+1;case"mmm":return this._dateFormatStrings.monthNames[t.getMonth()];case"mmmm":return this._dateFormatStrings.monthNames[t.getMonth()+12];case"yy":return t.getFullYear().toString().substring(2,4);default:return t.getFullYear()}};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
