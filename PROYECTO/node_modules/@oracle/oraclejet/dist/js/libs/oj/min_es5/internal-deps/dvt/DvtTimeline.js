...
/**
   ...
   * @ignore
   */
var t=new Object;t.supportsTouch=function(){return e.Agent.isTouchDevice()},e.Obj.createSubclass(t,e.Obj),t.getDatePosition=function(e,t,i,s){var r=(i-e)*s,n=t-e;return 0==r||0==n?0:r/n},t.getPositionDate=function(e,t,i,s){var r=i*(t-e);return 0==r||0==s?e:r/s+e};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var i=function(e){this.Init(e)};e.Obj.createSubclass(i,e.TimeComponentKeyboardHandler),i.getNextNavigable=function(t,s,r){var n=t.getSeries(),a=t.getSeriesIndex(),o=e.Agent.isRightToLeft(n.getCtx()),l=n.isVertical(),h=r.length>1;if(!o&&e.KeyboardEvent.RIGHT_ARROW==s.keyCode||o&&e.KeyboardEvent.LEFT_ARROW==s.keyCode){if(!l)return i.getNextItem(t,r[a],!0);if(h&&1!=a)return i.getClosestItem(t,r[1])}else if(!o&&e.KeyboardEvent.LEFT_ARROW==s.keyCode||o&&e.KeyboardEvent.RIGHT_ARROW==s.keyCode){if(!l)return i.getNextItem(t,r[a],!1);if(h&&0!=a)return i.getClosestItem(t,r[0])}else if(e.KeyboardEvent.DOWN_ARROW==s.keyCode){if(l)return i.getNextItem(t,r[a],!0);if(h&&1!=a)return i.getClosestItem(t,r[1])}else if(e.KeyboardEvent.UP_ARROW==s.keyCode){if(l)return i.getNextItem(t,r[a],!1);if(h&&0!=a)return i.getClosestItem(t,r[0])}return null},i.getNextItem=function(e,t,i){var s=t.indexOf(e)+(i?1:-1);return s>=0&&s<t.length?t[s]:null},i.getClosestItem=function(e,t){if(t.length>0){for(var i=t[0],s=e.getLoc(),r=Math.abs(s-i.getLoc()),n=1;n<t.length;n++){var a=Math.abs(s-t[n].getLoc());a<r&&(r=a,i=t[n])}return i}return null};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var r=function(e){this._timeline=e};e.Obj.createSubclass(r,e.Automation),r.TIMELINE_ITEM_STRING="timelineItem",r.prototype.GetSubIdForDomElement=function(e){var t=this._timeline.EventManager.GetLogicalObject(e);if(t&&t instanceof g)for(var i=0;i<this._timeline._series.length;i++){var s=this._timeline._series[i]._items.indexOf(t);if(-1!=s)return r.TIMELINE_ITEM_STRING+"["+i+"]["+s+"]"}return null},r.prototype.getDomElementForSubId=function(t){if(t==e.Automation.TOOLTIP_SUBID)return this.GetTooltipElement(this._timeline);if(t&&this._timeline.hasValidOptions()){var i=t.indexOf("[");if(i>0&&t.substring(0,i)===r.TIMELINE_ITEM_STRING){var s=t.indexOf("]");if(s>0){var n=parseInt(t.substring(i+1,s)),a=parseInt(t.substring(s+2,t.length-1)),o=this._timeline._series[n];if(o){var l=o._items[a];if(l)return l.getDisplayables()[0].getElem()}}}}return null};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var o=new Object;e.Obj.createSubclass(o,e.Obj),o.renderTimeline=function(t){if(o._renderBackground(t),o._renderScrollableCanvas(t),t.hasValidOptions()){t.renderTimeZoomCanvas(t._canvas);var i=t.getTimeZoomCanvas();if(o._renderSeries(t,i),o._renderSeriesLabels(t),o._renderAxis(t,i),t._hasOverview?o._renderOverview(t):t.clearOverview(),t._keyboardHandler)for(var s=0;s<t._series.length;s++){if((r=t._series[s])._items&&r._items.length>0){t.EventManager.setFocusObj(r._items[0]);break}}(t.isTimeDirScrollbarOn()||t.isContentDirScrollbarOn())&&o._renderScrollbars(t),o._renderZoomControls(t),t.SelectionHandler&&t.applyInitialSelections(),e.TimeAxis.supportsTouch()&&t._setAriaProperty("flowto",t._series[0].getId());for(s=0;s<t._series.length;s++){var r;(r=t._series[s]).triggerAnimations()}}else o._renderEmptyText(t)},o._renderBackground=function(t){t._background?(t._background.setClipPath(null),t._background.setWidth(t._backgroundWidth),t._background.setHeight(t._backgroundHeight)):t._background=new e.Rect(t.getCtx(),0,0,t._backgroundWidth,t._backgroundHeight,"bg");var i=t.getBackgroundXOffset();t._background.setTranslateX(i),t._background.setCSSStyle(t._style),t._background.setPixelHinting(!0);var s=new e.ClipPath;s.addRect(i,0,t._backgroundWidth,t._backgroundHeight),t._background.setClipPath(s),t._background.getParent()!=t&&t.addChild(t._background)},o._renderScrollableCanvas=function(t){t._canvas||(t._canvas=new e.Container(t.getCtx(),"canvas"),t.addChild(t._canvas))},o._renderSeries=function(t,i){var s=t.getTimeAxis();if(t._series){var r=t.getCtx(),n=e.Agent.isRightToLeft(r),a=t._series.length,o=t.getTimeAxisVisibleSize(a);t.isVertical()||a>1&&t._canvasSize%2!=o%2&&(s.setContentSize(s.getContentSize()+1),o=t.getTimeAxisVisibleSize(a)),t._seriesSize=(t._canvasSize-o)/a;for(var l=0;l<a;l++){var h=t._series[l];h.setClipPath(null);var _=new e.ClipPath;if(t.isVertical()){if(n)var c=Math.abs(l-1);else c=l;if(n&&1==t._series.length){_.addRect(o,0,t._seriesSize,t.getContentLength());var g=new e.Matrix(1,0,0,1,o,0)}else _.addRect(c*(t._seriesSize+o),0,t._seriesSize,t.getContentLength()),g=new e.Matrix(1,0,0,1,c*(t._seriesSize+o),0);var m=t._seriesSize,u=t.getContentLength()}else _.addRect(0,l*(t._seriesSize+o),t.getContentLength(),t._seriesSize),g=new e.Matrix(1,0,0,1,0,l*(t._seriesSize+o)),m=t.getContentLength(),u=t._seriesSize;h.setClipPath(_),h.setMatrix(g),h.getParent()!=i&&i.addChild(h),h.render(t._seriesOptions[l],m,u)}}},o._renderSeriesLabels=function(t){if(t._series){var i=t.getCtx(),s=e.Agent.isRightToLeft(i);if(t._seriesLabels)for(var r=0;r<t._seriesLabels.length;r++)t.removeChild(t._seriesLabels[r]);t._seriesLabels=[];var n=t._series.length,a=l.getSeriesLabelSpacing(),o=2*e.TransientButton._DEFAULT_RADIUS+6,h=2*a;for(r=0;r<n;r++){var _=t._series[r],c=_.getLabel();if(null!=c){var g=l.getSeriesLabelStyle(t.Options),m=new e.CSSStyle(l.getSeriesLabelBackgroundStyle());if(_._style){var u=_._style.getStyle(e.CSSStyle.BACKGROUND_COLOR);u&&m.setStyle(e.CSSStyle.BACKGROUND_COLOR,u)}var d=new e.OutputText(i,c,0,0,"sl_s"+r);d.setCSSStyle(g);var S=d.getDimensions();if(t.isVertical())var v=t._seriesSize;else v=t._canvasLength;var f=Math.min(S.w,v-(r-1)*-o-h),p=l.getSeriesLabelPadding(),T=new e.Rect(i,0,0,f+2*p,S.h+2*p,"slb_s"+r);if(T.setCSSStyle(m),T.setAlpha(l.getSeriesLabelBackgroundOpacity()),T.setCornerRadius(3),t.isVertical())b=s?Math.abs(r-1)*(t._canvasSize-f-h)+a+t._startX+(r-1)*o:r*(t._canvasSize-f-h)+a+t._startX+(r-1)*-o,O=t._startY+a;else{if(s)var b=t._canvasLength-f-a-(r-1)*-o;else b=t._startX+a+(r-1)*-o;var O=r*(t._canvasSize-S.h-h)+a+t._startY}var y=new e.Matrix(1,0,0,1,b,O);d.setMatrix(y),y=new e.Matrix(1,0,0,1,b-p,O-p),T.setMatrix(y),t.addChild(T),e.TextUtils.fitText(d,f,1/0,t),t._seriesLabels.push(T),t._seriesLabels.push(d)}if(_._isEmpty){var E=_.getEmptyText();if(null!=E){var A=new e.OutputText(i,E,0,0,"et_s"+r);A.setCSSStyle(l.getEmptyTextStyle(t.Options));S=A.getDimensions();if(t.isVertical())D=(t._canvasLength-S.h)/2+t._startY,C=s?Math.abs(r-1)*((n-1)*t._seriesSize+t.getTimeAxisVisibleSize(n))+(t._seriesSize-S.w)/2+t._startX:r*(t._seriesSize+t.getTimeAxisVisibleSize(n))+(t._seriesSize-S.w)/2+t._startX;else var C=(t._canvasLength-S.w)/2+t._startX,D=r*(t._seriesSize+t.getTimeAxisVisibleSize(n))+(t._seriesSize-S.h)/2+t._startY;y=new e.Matrix(1,0,0,1,C,D);A.setMatrix(y),t.addChild(A),t._seriesLabels.push(A)}}}}},o._renderAxis=function(t,i){var s=t.getCtx(),r=e.Agent.isRightToLeft(s),n=t.getTimeAxis(),a=t._series.length,l=t.getTimeAxisSize(),h=t.getTimeAxisVisibleSize(a),_=1==a?t._canvasSize-h:t._canvasSize/a-h/2;if(r&&t.isVertical()&&1==t._series.length&&(_=0),n.getParent()!==i&&i.addChild(n),t.isVertical()){var c=new e.Matrix(1,0,0,1,_,0);n.render(null,l,t.getContentLength())}else c=new e.Matrix(1,0,0,1,0,_),n.render(null,t.getContentLength(),l);n.setMatrix(c),o._renderSeriesTimeAxis(t,t._fetchStartPos,t._fetchEndPos,t.getTimeZoomCanvas(),t.getContentLength())},o._renderSeriesTimeAxis=function(t,i,s,r,n){var a=t.getCtx(),h=e.Agent.isRightToLeft(a);if(t._majorAxisLabels)for(var _=0;_<t._majorAxisLabels.length;_++)r.removeChild(t._majorAxisLabels[_]);if(t._majorAxisLabels=[],t._seriesScale){var c,g,m=t._start,u=t._end;if(t._customTimeScales&&t._customTimeScales[t._seriesScale]){var d=t._customTimeScales[t._seriesScale];c=d.times,g=d.labels}else if(t._seriesCustomFormatScales&&t._seriesCustomFormatScales[t._seriesScale]){var S=t._seriesCustomFormatScales[t._seriesScale];c=S.times,g=S.labels}else{c=[],g=[];var v=e.TimeAxis.getPositionDate(m,u,i,n),f=t._seriesTimeAxis.adjustDate(v),p=e.TimeAxis.getDatePosition(m,u,f,n);for(c.push(f.getTime());p<s;)g.push(t._seriesTimeAxis.formatDate(f)),f=t._seriesTimeAxis.getNextDate(f.getTime()),p=e.TimeAxis.getDatePosition(m,u,f,n),c.push(f.getTime())}var T=l.getSeriesAxisLabelStyle(t.Options),b=l.getSeriesAxisLabelPadding(),O=new e.CSSStyle(l.getSeriesAxisLabelBackgroundStyle());if(t._series[0]&&t._series[0]._style){var y=t._series[0]._style.getStyle(e.CSSStyle.BACKGROUND_COLOR);y&&O.setStyle(e.CSSStyle.BACKGROUND_COLOR,y)}var E=l.getSeriesAxisLabelBackgroundOpacity();for(_=0;_<g.length;_++){var A=g[_],C=c[_];p=e.TimeAxis.getDatePosition(m,u,C,n);var D=e.TimeAxis.getDatePosition(m,u,c[_+1],n)-p;if(h)w=t.isVertical()?o._addLabel(a,r,t._canvasSize-5,A,D,p+18,T,"o_label"+p+"_s0",!0,O,E,b,t._majorAxisLabels,h):o._addLabel(a,r,n-(p+5),A,D,t._seriesSize-2,T,"o_label"+p+"_s0",!0,O,E,b,t._majorAxisLabels,h);else if(t.isVertical())var w=o._addLabel(a,r,5,A,D,p+18,T,"o_label"+p+"_s0",!0,O,E,b,t._majorAxisLabels,h);else w=o._addLabel(a,r,p+5,A,D,t._seriesSize-2,T,"o_label"+p+"_s0",!0,O,E,b,t._majorAxisLabels,h);w.time=c[_]}}},o._renderOverview=function(t){var i=t.getCtx(),s=e.Agent.isRightToLeft(i);if(null==t._overviewCanvas){var r=!0;t._overviewCanvas=new e.Container(i,"oCanvas")}else t._overviewCanvas.removeChildren(),t._overviewCanvas.setClipPath(null);var n,a,o,l,h=t._style.getBorderWidth(),_=h/2;t.isVertical()?(n=t._overviewSize,a=t._backgroundHeight-h,l=_,o=s?_:t._backgroundWidth-t._overviewSize-_):(n=t._backgroundWidth-h,a=t._overviewSize,l=t._backgroundHeight-t._overviewSize-_,o=_+t.getBackgroundXOffset()),t._overviewCanvas.setTranslateX(o),t._overviewCanvas.setTranslateY(l);var c=new e.ClipPath;c.addRect(o,l,n,a),t._overviewCanvas.setClipPath(c),r&&t.addChild(t._overviewCanvas),t._overview=new e.TimelineOverview(i,t.HandleEvent,t),t._overviewCanvas.addChild(t._overview);var g=t._getOverviewObject();t._overview.render(g,n,a)},o._renderScrollbars=function(t){var i=t.getCtx(),s=t.getScrollbarPadding();if(null==t._scrollbarsCanvas?(t._scrollbarsCanvas=new e.Container(i,"sbCanvas"),t.addChild(t._scrollbarsCanvas)):(t._scrollbarsCanvas.removeChildren(),t.setTimeDirScrollbar(null),t.setContentDirScrollbar(null)),t.isTimeDirScrollbarOn()){if(t.isVertical()){if(e.Agent.isRightToLeft(t.getCtx()))var r=2*s+1;else r=t.Width-1.5*s;var n=t.getCanvasLength()}else r=t.getCanvasLength(),n=t.Height-1.5*s;var a=o._prerenderTimeDirScrollbar(t,t._scrollbarsCanvas,new e.Rectangle(0,0,r,n))}if(t.isContentDirScrollbarOn()){t.isVertical()?(r=t._seriesSize,n=t.Height-1.5*s):(r=e.Agent.isRightToLeft(t.getCtx())?2*s+1:t.Width-1.5*s,n=t._seriesSize);for(var l=t._series.length,h=[],_=0;_<l;_++)h[_]=o._prerenderContentDirScrollbar(t,t._scrollbarsCanvas,new e.Rectangle(0,0,r,n),_)}if(t.timeDirScrollbar){var c={};c.color=t.timeDirScrollbarStyles.getStyle(e.CSSStyle.COLOR),c.backgroundColor=t.timeDirScrollbarStyles.getStyle(e.CSSStyle.BACKGROUND_COLOR),c.min=t._start,c.max=t._end,t.isVertical()?(c.isReversed=!1,c.isHorizontal=!1,t.timeDirScrollbar.setTranslateY(t.getStartYOffset())):(c.isReversed=e.Agent.isRightToLeft(i),c.isHorizontal=!0,t.timeDirScrollbar.setTranslateX(t.getStartXOffset())),t.timeDirScrollbar.render(c,a.w,a.h),t.timeDirScrollbar.setViewportRange(t._viewStartTime,t._viewEndTime)}if(t.contentDirScrollbar)for(_=0;_<l;_++)(c={}).color=t.contentDirScrollbarStyles.getStyle(e.CSSStyle.COLOR),c.backgroundColor=t.contentDirScrollbarStyles.getStyle(e.CSSStyle.BACKGROUND_COLOR),c.isHorizontal=t.isVertical(),0==_?(c.min=0,c.max=Math.max(t._series[_]._maxOverflowValue,h[_].h),t.isVertical()?e.Agent.isRightToLeft(i)?(c.isReversed=!1,2==l?t.contentDirScrollbar[_].setTranslateX(t.getStartXOffset()+t._seriesSize+t.getTimeAxisVisibleSize(l)):t.contentDirScrollbar[_].setTranslateX(t.getStartXOffset()+t.getTimeAxisVisibleSize(l))):(c.isReversed=!0,t.contentDirScrollbar[_].setTranslateX(t.getStartXOffset())):(c.isReversed=!0,t.contentDirScrollbar[_].setTranslateY(t.getStartYOffset()))):(c.min=0,c.max=Math.max(t._series[_]._maxOverflowValue,h[_].h),t.isVertical()?e.Agent.isRightToLeft(i)?(c.isReversed=!0,t.contentDirScrollbar[_].setTranslateX(t.getStartXOffset())):(c.isReversed=!1,t.contentDirScrollbar[_].setTranslateX(t.getStartXOffset()+t._seriesSize+t.getTimeAxisVisibleSize(l))):(c.isReversed=!1,t.contentDirScrollbar[_].setTranslateY(t.getStartYOffset()+t._seriesSize+t.getTimeAxisVisibleSize(l)))),t.contentDirScrollbar[_].render(c,h[_].w,h[_].h),t.contentDirScrollbar[_].setViewportRange(0,t._seriesSize)},o._prerenderTimeDirScrollbar=function(t,i,s){if(t.setTimeDirScrollbar(new e.SimpleScrollbar(t.getCtx(),t.HandleEvent,t)),i.addChild(t.timeDirScrollbar),t.isVertical())var r="right",n=e.CSSStyle.toNumber(t.timeDirScrollbarStyles.getWidth()),a=s.h;else r="bottom",n=s.w,a=e.CSSStyle.toNumber(t.timeDirScrollbarStyles.getHeight());return e.LayoutUtils.position(s,r,t.timeDirScrollbar,n,a,0),new e.Dimension(n,a)},o._prerenderContentDirScrollbar=function(t,i,s,r){if(t.setContentDirScrollbar(new e.SimpleScrollbar(t.getCtx(),t.HandleEvent,t),r),i.addChild(t.contentDirScrollbar[r]),t.isVertical())var n="bottom",a=s.w,o=e.CSSStyle.toNumber(t.contentDirScrollbarStyles.getHeight());else n="right",a=e.CSSStyle.toNumber(t.contentDirScrollbarStyles.getWidth()),o=s.h;return e.LayoutUtils.position(s,n,t.contentDirScrollbar[r],a,o,0),new e.Dimension(a,o)},o._renderZoomControls=function(t){var i=t.getCtx(),s=t._resources,r=e.Agent.isRightToLeft(i),n={zoomInProps:{imageSize:16,class:s.zoomIn},zoomOutProps:{imageSize:16,class:s.zoomOut}},a=t.getStartXOffset()+l._DEFAULT_ZOOM_CONTROL_PADDING;r&&(t._isVertical&&t._hasOverview?a-=t._overviewSize:a-=t.getBackgroundXOffset(),a=t._backgroundWidth-a-l._DEFAULT_ZOOM_CONTROL_DIAMETER),n.zoomInProps.posX=a,n.zoomOutProps.posX=a;var o=t._startY+l._DEFAULT_ZOOM_CONTROL_PADDING;n.zoomInProps.posY=o,n.zoomOutProps.posY=o+l._DEFAULT_ZOOM_CONTROL_DIAMETER+l._DEFAULT_ZOOM_CONTROL_SPACING,t.renderZoomControls(n)},o._renderEmptyText=function(t){if(t.Options.series)var i=t.Options.translations.labelInvalidData;else i=t.Options.translations.labelNoData;t.clearComponent(),e.TextUtils.renderEmptyText(t._canvas,i,new e.Rectangle(0,0,t._backgroundWidth,t._backgroundHeight),t.EventManager,l.getEmptyTextStyle(t.Options))},o._addLabel=function(t,i,s,r,n,a,o,l,h,_,c,g,m,u){var d=new e.OutputText(t,r,s,0,l);null!=o&&d.setCSSStyle(o);var S=d.getDimensions();if(a-=S.h,d.setY(a),u&&d.setX(s-S.w),h){var v=Math.min(S.w+2*g,n);if(u)f=s-v+2*g;else var f=s;var p=new e.Rect(t,f-g,a-g,v,S.h+2*g,"ob_"+l);p.setCSSStyle(_),p.setCornerRadius(3),p.setAlpha(c),i.addChild(p),m&&m.push(p)}return e.TextUtils.fitText(d,n,1/0,i),m&&m.push(d),d};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var h=function(e,t,i){this.Init(e,t,i)};e.Obj.createSubclass(h,e.BaseComponent),h.prototype.Init=function(e,t,i){h.superclass.Init.call(this,e),this._callback=t,this._callbackObj=i,this._blocks=[],this._renderedReferenceObjects=[],this._seriesTicksArray=[]},h.prototype.triggerAnimations=function(){var t=this.getCtx();if(this._rmAnimationElems&&0!=this._rmAnimationElems.length){this._callbackObj.EventManager.removeListeners(this._callbackObj);var i=new e.ParallelPlayable(t,new e.AnimFadeOut(t,this._rmAnimationElems,l.getAnimationDuration(this.Options)));e.Playable.appendOnEnd(i,this._onRmAnimationEnd,this),this._callbackObj.Animation=i,i.play()}else if(this._mvAnimator&&this._hasMvAnimations)this._callbackObj.EventManager.removeListeners(this._callbackObj),e.Playable.appendOnEnd(this._mvAnimator,this._onMvAnimationEnd,this),this._callbackObj.Animation=this._mvAnimator,this._mvAnimator.play();else if(this._frAnimationElems&&0!=this._frAnimationElems.length){this._callbackObj.EventManager.removeListeners(this._callbackObj);var s=new e.ParallelPlayable(t,new e.AnimFadeIn(t,this._frAnimationElems,l.getAnimationDuration(this.Options),(this._isInitialRender,0)));e.Playable.appendOnEnd(s,this._onAnimationEnd,this),this._callbackObj.Animation=s,s.play()}},h.prototype._onRmAnimationEnd=function(){for(var t=0;t<this._rmAnimationElems.length;t++){var i=this._rmAnimationElems[t],s=i.getParent();s&&s.removeChild(i)}this._mvAnimator&&this._hasMvAnimations?(this._callbackObj.Animation=this._mvAnimator,e.Playable.appendOnEnd(this._mvAnimator,this._onMvAnimationEnd,this),this._mvAnimator.play()):this._onMvAnimationEnd()},h.prototype._onMvAnimationEnd=function(){if(this._frAnimationElems&&0!=this._frAnimationElems.length){var t=new e.ParallelPlayable(this.getCtx(),new e.AnimFadeIn(this.getCtx(),this._frAnimationElems,l.getAnimationDuration(this.Options),(this._isInitialRender,0)));e.Playable.appendOnEnd(t,this._onAnimationEnd,this),this._callbackObj.Animation=t,t.play()}else this._onAnimationEnd()},h.prototype._onAnimationEnd=function(){this._callbackObj.onAnimationEnd()},h.prototype.render=function(t,i,s){if(t){this.SetOptions(t),this.Width?this._isInitialRender=!1:this._isInitialRender=!0,this.Width=i,this.Height=s;var r=this.Options.orientation;if(r&&r==e.Timeline.ORIENTATION_VERTICAL?(0==this._isVertical?this._allowUpdates=!1:this._allowUpdates=!0,this._isVertical=!0):(this._isVertical?this._allowUpdates=!1:this._allowUpdates=!0,this._isVertical=!1),this.Options){var n=this.Parse(this.Options);this._applyParsedProperties(n)}this._fetchStartPos=0,this._isVertical?(this._fetchEndPos=s,this._maxOverflowValue=i,this._length=s,this._size=i):(this._fetchEndPos=i,this._maxOverflowValue=s,this._length=i,this._size=s),this._isInverted=this.Options.inverted,this._colorCount=0,this._maxDurationSize=0,u.renderSeries(this,i,s),e.TimeAxis.supportsTouch()&&this._items.length>0&&this._setAriaProperty("flowto","_bt_"+this._items[0].getId());var a=this.GetComponentDescription();a&&(e.ToolkitUtils.setAttrNullNS(this.getElem(),"role","img"),e.ToolkitUtils.setAttrNullNS(this.getElem(),"aria-label",e.TextUtils.processAriaLabel(a)))}else this._handleResize(i,s)},h.prototype.GetComponentDescription=function(){var t=this.Options.translations,i=[t.labelSeries];return this._label?i.push(this._label):i.push(this.Options.index+1),e.ResourceUtils.format(t.labelAndValue,i)},h.prototype._handleResize=function(e,t){this._canvas.setTranslateY(0),this._canvas.setTranslateX(0),this.Width=e,this.Height=t,this._fetchStartPos=0,this._isVertical?(this._fetchEndPos=t,this._maxOverflowValue=e,this._length=t,this._size=e):(this._fetchEndPos=e,this._maxOverflowValue=t,this._length=e,this._size=t),this._background.setWidth(e),this._background.setHeight(t),u.updateSeriesForZoom(this)},h.prototype.applyStyleValues=function(){if(this._style=new e.CSSStyle(l.getSeriesStyle()),this._seriesStyleDefaults=this.Options.seriesStyleDefaults,this._axisStyleDefaults=this.Options.axisStyleDefaults,this._colors=l.getColorsArray(this.Options),this._referenceObjects=this.Options.referenceObjects,this._seriesStyleDefaults){var t=this._seriesStyleDefaults.backgroundColor;t&&this._style.parseInlineStyle("background-color:"+t+";")}this._style.parseInlineStyle(this._inlineStyle)},h.prototype.SetOptions=function(e){this.Options=e},h.prototype.Parse=function(e){return this._parser=new m(this.getCtx()),this._parser.parse(e,this._items)},h.prototype._applyParsedProperties=function(e){this._items&&(this._oldItems=this._items),this._items=e.items,this._items&&this._items.length>0?this._isEmpty=!1:this._isEmpty=!0,this._isIRAnimationEnabled=e.isIRAnimationEnabled,this._isDCAnimationEnabled=e.isDCAnimationEnabled,this._label=e.label,this._timeAxis=e.timeAxis,this._emptyText=e.emptyText,null==this._emptyText&&(this._emptyText=this.Options.translations.labelNoData),this._isTopToBottom=e.isTopToBottom,this._isRandomItemLayout=e.isRandomItemLayout,this._customTimeScales=e.customTimeScales,this._customFormatScales=e.customFormatScales,this._start=e.start,this._end=e.end,this._inlineStyle=e.inlineStyle,this._scale=e.scale,this._converter=e.converter,this._data=e.data,this.applyStyleValues()},h.prototype.calculateSpacing=function(e,t){if(null!=this._items&&0!=this._items.length){var i=this._maxOverflowValue,s=e.getSpacing();if(this._isRandomItemLayout){if(null==s){var r=e.getHeight(),n=this._initialSpacing,a=this._maxOverflowValue-r-n;a<0&&(a=0),s=Math.round(Math.random()*a)+n,this._maxOverflowValue<s+r&&(this._maxOverflowValue=s+r+l.getBubbleSpacing())}return s}if(null==s&&(s=this._initialSpacing),this._isVertical)for(g=0;g<t;g++){i<s+(m=(v=this._items[g]).getWidth()+10)&&(i=s+m)}else{for(var o=e.getLoc(),h=e.getWidth()+10,_=l.getBubbleSpacing(),c=[],g=0;g<t;g++){var m=(v=this._items[g]).getWidth()+10,u=v.getLoc();(o>=u&&o<=u+m||u>=o&&u<=o+h)&&c.push(v)}for(var g=0;g<c.length;g++){for(var d=!1,S=0;S<c.length;S++){var v,f=(v=c[S]).getHeight(),p=v.getSpacing();if(s>=p&&s<=p+f){s=p+f+_,e.setSpacing(s),d=!0;break}}if(!d)break}i<s+f&&(i=s+f)}return i>this._maxOverflowValue&&(this._maxOverflowValue=i+l.getBubbleSpacing()),s}},h.prototype.calculateDurationSize=function(e,t){if(null!=this._items&&0!=this._items.length){var i=e.getStartTime(),s=e.getEndTime();if(s&&s!=i){var r=e.getDurationLevel();null==r&&(r=1);for(var n=[],a=0;a<t;a++){var o=(c=this._items[a]).getStartTime(),l=c.getEndTime();l&&l!=o&&(i>=o&&i<=l&&n.push(c))}for(a=0;a<n.length;a++){for(var h=!1,_=0;_<n.length;_++){var c,g=(c=n[_]).getDurationLevel();if(r==g){r=g+1,e.setDurationLevel(r),h=!0;break}}if(!h)break}return r>this._maxDurationSize&&(this._maxDurationSize=r),r}}},h.prototype.prepareDurations=function(e){for(var t=0;t<this._items.length;t++){var i=this._items[t],s=i.getStartTime(),r=i.getEndTime();r&&r!=s&&(i.setDurationLevel(this.calculateDurationSize(i,t)),i.setDurationSize(22+10*i.getDurationLevel()-5),null==i.getDurationFillColor()&&(i.setDurationFillColor(this._colors[this._colorCount]),this._colorCount++,this._colorCount==this._colors.length&&(this._colorCount=0)))}},h.prototype.prepareItems=function(t){this.isVertical()?this._initialSpacing=20*(this._maxDurationSize>0?1:0)+l.getBubbleSpacing()+10*this._maxDurationSize:this._initialSpacing=20+l.getBubbleSpacing()+10*this._maxDurationSize;for(var i=0;i<t.length;i++){var s=t[i],r=e.TimeAxis.getDatePosition(this._start,this._end,s.getStartTime(),this._length),n=s.getEndTime();if(n&&n!=s.getStartTime()){var a=e.TimeAxis.getDatePosition(this._start,this._end,n,this._length)-r;r+=Math.min(l.getDurationFeelerOffset(),a/2)}s.setLoc(r)}for(i=0;i<this._items.length;i++){s=this._items[i];(r=e.TimeAxis.getDatePosition(this._start,this._end,s.getStartTime(),this._length))<this._fetchStartPos||r>this._fetchEndPos||c.initializeItem(s,this,i)}},h.prototype.getData=function(t){if(t){var i={emptyText:this._data.emptyText,id:this._data.id,itemLayout:this._data.itemLayout,label:this._data.label,svgStyle:this._data.svgStyle,items:this._data.items};return e.TimeComponent.sanitizeData(i,"series")}return this._data},h.prototype.getLabel=function(){return this._label},h.prototype.getEmptyText=function(){return this._emptyText},h.prototype.findItem=function(t){if(null!=this._items)for(var i=0;i<this._items.length;i++){var s=this._items[i];if(e.Obj.compareValues(this.getCtx(),s.getId(),t))return s}return null},h.prototype.isInverted=function(){return this._isInverted},h.prototype.isTopToBottom=function(){return this._isTopToBottom},h.prototype.isVertical=function(){return this._isVertical},h.prototype.addTick=function(t,i,s,r,n,a,o){var l=new e.Line(this.getCtx(),i,r,s,n,o);return l.setStroke(a),l.setPixelHinting(!0),t.addChild(l),l},h.prototype.setVScrollPos=function(e){null!=this._canvas&&this._canvas.setTranslateY(0-e)},h.prototype.setHScrollPos=function(e){null!=this._canvas&&this._canvas.setTranslateX(0-e)};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var _=function(e,t){this.Init(e,t)};e.Obj.createSubclass(_,e.Container),_.ENABLED_STATE_KEY="en",_.SELECTED_STATE_KEY="sel",_.ACTIVE_SELECTED_STATE_KEY="asel",_.HOVER_STATE_KEY="hl",_.prototype.Init=function(e,t){_.superclass.Init.call(this,e,"g",t)},_.prototype.setSelected=function(e){this._isSelected!=e&&(this._isSelected=e,e?this._isShowingHoverEffect?this.applyState(_.ACTIVE_SELECTED_STATE_KEY):this.applyState(_.SELECTED_STATE_KEY):this.applyState(_.ENABLED_STATE_KEY))},_.prototype.showHoverEffect=function(e){this._isShowingHoverEffect||(this._isShowingHoverEffect=!0,this._isSelected&&e?this.applyState(_.ACTIVE_SELECTED_STATE_KEY):this._isSelected?this.applyState(_.SELECTED_STATE_KEY):this.applyState(_.HOVER_STATE_KEY))},_.prototype.hideHoverEffect=function(e){this._isSelected&&e?this.applyState(_.ACTIVE_SELECTED_STATE_KEY):this._isSelected?this.applyState(_.SELECTED_STATE_KEY):this.applyState(_.ENABLED_STATE_KEY),this._isShowingHoverEffect=!1},_.prototype.applyState=function(t){var i=this._node,s=i.getBubble();if(null!=s){var r=s.getChildAt(0),n=r.getChildAt(0),a=i.getDurationBar();if(t==_.ACTIVE_SELECTED_STATE_KEY)var o=l.getItemSelectedFillColor(i),h=l.getItemSelectedStrokeColor(i),c=l.getItemSelectedStrokeWidth(),g=l.getItemInnerActiveStrokeColor();else t==_.SELECTED_STATE_KEY?(o=l.getItemSelectedFillColor(i),h=l.getItemSelectedStrokeColor(i),c=l.getItemSelectedStrokeWidth(),g=l.getItemInnerStrokeColor()):t==_.HOVER_STATE_KEY?(o=l.getItemHoverFillColor(i),h=l.getItemHoverStrokeColor(i),c=l.getItemHoverStrokeWidth(),g=l.getItemInnerActiveStrokeColor()):(o=l.getItemFillColor(i),h=l.getItemStrokeColor(i),c=l.getItemStrokeWidth(),g=l.getItemInnerStrokeColor());var m=l.getItemInnerStrokeWidth(),u=new e.Stroke(h,1,c),d=new e.Stroke(g,1,m);r.setSolidFill(o),r.setStroke(u),n.setStroke(d);var S=i.getFeeler();S&&S.setStroke(u),a&&a.setStroke(u)}};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var c=new Object;e.Obj.createSubclass(c,e.Obj),c.renderItem=function(e,t,i,s,r,n){e._content?(c._renderBubble(e,t,i,r),c._displayBubble(e,t,s,null,!1)):(t._hasMvAnimations=!0,c._displayBubble(e,t,s,n,!0)),t.isVertical()||(e.getFeeler()&&t._allowUpdates?c._updateFeeler(e,t,s,n):c._renderFeeler(e,t,i.feelers,s,r))},c.initializeItem=function(e,t,i){e.getBubble()&&t._allowUpdates?c._updateBubble(e,t,i):c._createBubble(e,t,i)},c._createBubble=function(e,t,i){var s=c._getBubbleContent(e,t);e.setWidth(s._w+10),e.setHeight(s._h+10),e._content=s;var r=t.calculateSpacing(e,i);e.setSpacing(r)},c._renderBubble=function(t,i,s,r){var n=i.getCtx(),a=e.Agent.isRightToLeft(n),o=t.getId(),h=t._content;t._content=null;var c=t.getWidth(),g=t.getHeight(),m="_bubble_"+o;if(i.isVertical()){var u=g/2,d=u-6,S=u+6;if(!a&&i.isInverted()||a&&!i.isInverted())var v=[0,0,0,d,-6,u,0,S,0,g,c,g,c,0,0,0],f=[2,2,2,d,-4,u,2,S,2,g-2,c-2,g-2,c-2,2,2,2];else v=[0,0,0,g,c,g,c,S,c+6,u,c,d,c,0,0,0],f=[2,2,2,g-2,c-2,g-2,c-2,S,c+4,u,c-2,d,c-2,2,2,2]}else d=(u=a?c-l.getBubbleOffset():l.getBubbleOffset())-6,S=u+6,i.isInverted()?(v=[0,0,d,0,u,-6,S,0,c,0,c,g,0,g,0,0],f=[2,2,d,2,u,-4,S,2,c-2,2,c-2,g-2,2,g-2,2,2]):(v=[0,0,0,g,d,g,u,g+6,S,g,c,g,c,0,0,0],f=[2,2,2,g-2,d,g-2,u,g+4,S,g-2,c-2,g-2,c-2,2,2,2]);var p=new e.Polygon(n,v,m),T=new e.Polygon(n,f,m+"_i");T.setSolidFill(l.getItemInnerFillColor()),h.setTranslate(5,5),p.addChild(T),p.addChild(h);var b=new _(n,"_bt_"+o);r&&(b.setAlpha(0),r.push(b)),b.addChild(p),e.TimeAxis.supportsTouch()&&e.ToolkitUtils.setAttrNullNS(b._elem,"id",b._id),b._node=t,t.setBubble(b),b.applyState(_.ENABLED_STATE_KEY),t.getLoc()>=0&&s.addChild(b),b.setAriaRole("img"),i._callbackObj.EventManager.associate(b,t)},c._displayBubble=function(t,i,s,r,n){var a,o,h=i.getCtx(),c=e.Agent.isRightToLeft(h),g=t.getLoc(),m=t.getWidth(),u=t.getHeight(),d=t.getSpacing(),S=t.getBubble();n&&S.applyState(_.ENABLED_STATE_KEY),i.isVertical()?(o=g-u/2,c&&i.isInverted()||!c&&!i.isInverted()?a=i._size-(m+i._initialSpacing)+s:(a=i._initialSpacing,s=0)):(a=c?i._length-g-m+l.getBubbleOffset():g-l.getBubbleOffset(),i.isInverted()?(o=i.isTopToBottom()?d:i.Height-d-u+s+i._initialSpacing-l.getBubbleSpacing(),s=0):o=i.isTopToBottom()?d-i._initialSpacing+l.getBubbleSpacing():i.Height-d-u+s),r?(i.isVertical()?S.setTranslateX(S.getTranslateX()+i._canvasOffsetX+s):S.setTranslateY(S.getTranslateY()+i._canvasOffsetY+s),r.addProp(e.Animator.TYPE_NUMBER,S,S.getTranslateX,S.setTranslateX,a),r.addProp(e.Animator.TYPE_NUMBER,S,S.getTranslateY,S.setTranslateY,o)):S.setTranslate(a,o),t._updateAriaLabel()},c._getBubbleContent=function(t,i){var s=i.getCtx(),r=e.Agent.isRightToLeft(s),n=t.getTitle(),a=t.getDescription(),o=t.getThumbnail(),h=new e.Container(s),_=0,c=0,g=0,m=0,u=0;if(r){if(n&&((p=new e.OutputText(s,n,0,0)).setCSSStyle(l.getItemTitleStyle(t)),_=(T=p.getDimensions()).w,c=u=T.h,h.addChild(p)),a){(b=new e.OutputText(s,a,0,c)).setCSSStyle(l.getItemDescriptionStyle(t));var d=(T=b.getDimensions()).w;0!=_&&d!=_?d>_?(p.setX(d-_),_=d):b.setX(_-d):_=d,u=c+T.h,h.addChild(b)}o&&(S=l.getThumbnailWidth(),v=l.getThumbnailHeight(),_=0==_?0:_+l.getItemContentSpacing(),(f=new e.Image(s,o,_,0,S,v,"_tn")).setMouseEnabled(!1),h.addChild(f),g=S,m=v),h._w=_+g}else{if(o){var S=l.getThumbnailWidth(),v=l.getThumbnailHeight(),f=new e.Image(s,o,0,0,S,v,"_tn");f.setMouseEnabled(!1),h.addChild(f),_=S+l.getItemContentSpacing(),m=v}if(n){var p=new e.OutputText(s,n,_,0);p.setCSSStyle(l.getItemTitleStyle(t));var T=p.getDimensions();g=T.w,c=u=T.h,h.addChild(p)}if(a){var b=new e.OutputText(s,a,_,c);b.setCSSStyle(l.getItemDescriptionStyle(t)),T=b.getDimensions(),g=Math.max(g,T.w),u=c+T.h,h.addChild(b)}h._w=0==g?Math.max(_-l.getItemContentSpacing(),0):_+g}return h._h=Math.max(m,u),h},c._updateBubble=function(e,t,i){var s=t.calculateSpacing(e,i);e.setSpacing(s)},c._renderFeeler=function(t,i,s,r,n){var a,o=i.getCtx(),h=e.Agent.isRightToLeft(o),_=t.getId(),c=t.getLoc(),g=t.getSpacing(),m="_feeler_"+_;if(i.isInverted())u=t.getDurationSize(),d=i.isTopToBottom()?g:i.Height-g-t.getHeight()+r+i._initialSpacing-l.getBubbleSpacing();else{var u=i.Height+r-t.getDurationSize();if(i.isTopToBottom())d=g-i._initialSpacing+l.getBubbleSpacing()+t.getHeight();else var d=i.Height-g+r}a=h?i._length-c:c;var S=new e.Line(o,a,u,a,d,m);n&&(S.setAlpha(0),n.push(S)),s.addChild(S);var v=l.getItemStrokeWidth(),f=l.getItemStrokeColor(t),p=new e.Stroke(f,1,v);S.setStroke(p),S._node=t,t.setFeeler(S)},c._updateFeeler=function(t,i,s,r){if(i.isVertical())t.setFeeler(null);else{var n,a=i.getCtx(),o=e.Agent.isRightToLeft(a),h=t.getFeeler();if(i.isInverted())_=t.getDurationSize(),c=i.isTopToBottom()?t.getSpacing():i.Height-t.getSpacing()-t.getHeight()+s+i._initialSpacing-l.getBubbleSpacing(),s=0;else{var _=i.Height+s-t.getDurationSize();if(i.isTopToBottom())c=t.getSpacing()-i._initialSpacing+l.getBubbleSpacing()+t.getHeight();else var c=i.Height-t.getSpacing()+s}n=o?i._length-t.getLoc():t.getLoc(),r?(h.setY1(h.getY1()+i._canvasOffsetY+s),h.setY2(h.getY2()+i._canvasOffsetY+s),r.addProp(e.Animator.TYPE_NUMBER,h,h.getX1,h.setX1,n),r.addProp(e.Animator.TYPE_NUMBER,h,h.getY1,h.setY1,_),r.addProp(e.Animator.TYPE_NUMBER,h,h.getX2,h.setX2,n),r.addProp(e.Animator.TYPE_NUMBER,h,h.getY2,h.setY2,c)):(h.setX1(n),h.setY1(_),h.setX2(n),h.setY2(c))}},c.renderDuration=function(e,t,i,s,r,n){e.getDurationBar()?c._updateDuration(e,t,s,n):c._renderDuration(e,t,i,s,r)},c._renderDuration=function(t,i,s,r,n){var a=i.getCtx(),o=e.Agent.isRightToLeft(a),h=t.getStartTime(),_=t.getEndTime(),c=e.TimeAxis.getDatePosition(i._start,i._end,h,i._length),g="_duration_"+t.getId(),m=22+10*t.getDurationLevel(),u=e.TimeAxis.getDatePosition(i._start,i._end,_,i._length);if(i.isVertical()){if(!o&&!i.isInverted()||o&&i.isInverted())var d=new e.Rect(a,i._size-m+5,c,m,u-c,g);else d=new e.Rect(a,-5,c,m,u-c,g),r=0;d.setTranslateX(r),d.setY(c),d.setWidth(m),d.setHeight(u-c)}else{var S=u-c;if(o)v=i._length-c-S;else var v=c;i.isInverted()?(d=new e.Rect(a,v,-5,S,m,g)).setTranslateY(0):(d=new e.Rect(a,v,i._size-m+5,S,m,g)).setTranslateY(r)}n&&(d.setAlpha(0),n.push(d)),d.setCornerRadius(5),d.setSolidFill(t.getDurationFillColor());var f=l.getItemStrokeWidth(),p=l.getItemStrokeColor(t),T=new e.Stroke(p,1,f);d.setStroke(T),d._node=t,i._callbackObj.EventManager.associate(d,t),s.addChild(d),t.setDurationBar(d)},c._updateDuration=function(t,i,s,r){var n=i.getCtx(),a=e.Agent.isRightToLeft(n),o=t.getDurationBar();if(null!=o){var l=e.TimeAxis.getDatePosition(i._start,i._end,t.getStartTime(),i._length),h=22+10*t.getDurationLevel(),_=e.TimeAxis.getDatePosition(i._start,i._end,t.getEndTime(),i._length);if(i.isVertical()){var c=0;if(!a&&!i.isInverted()||a&&i.isInverted())var g=i._size-h+5;else g=-5,s=0;var m=s,u=l,d=h,S=_-l}else{m=0;var v=_-l;g=a?i._length-l-v:l,i.isInverted()?(s=0,c=0,u=-5,d=v,S=h):(c=s,u=i._size-h+5,d=v,S=h)}r?(i.isVertical()?o.setTranslateX(o.getTranslateX()+i._canvasOffsetX+s):o.setTranslateY(o.getTranslateY()+i._canvasOffsetY+s),r.addProp(e.Animator.TYPE_NUMBER,o,o.getTranslateX,o.setTranslateX,m),r.addProp(e.Animator.TYPE_NUMBER,o,o.getTranslateY,o.setTranslateY,c),r.addProp(e.Animator.TYPE_NUMBER,o,o.getX,o.setX,g),r.addProp(e.Animator.TYPE_NUMBER,o,o.getY,o.setY,u),r.addProp(e.Animator.TYPE_NUMBER,o,o.getWidth,o.setWidth,d),r.addProp(e.Animator.TYPE_NUMBER,o,o.getHeight,o.setHeight,S)):(o.setTranslateX(m),o.setTranslateY(c),o.setX(g),o.setY(u),o.setWidth(d),o.setHeight(S))}};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var m=function(e){this._context=e};e.Obj.createSubclass(m,e.Obj),m.prototype.parse=function(e,t){var i=this.buildData(e),s=new Object;return s.start=new Date(e.start).getTime(),s.end=new Date(e.end).getTime(),s.inlineStyle=e.style,e.svgStyle&&(s.inlineStyle=e.svgStyle),s.scale=e.scale,s.timeAxis=e.timeAxis,s.label=e.label,s.emptyText=e.emptyText,s.isIRAnimationEnabled="auto"==e.animationOnDisplay,s.isDCAnimationEnabled="auto"==e.animationOnDataChange,s.items=this._parseDataNode(e.timeline,e.index,i.data,t,s.start,s.end),s.rtl="false",s.isRandomItemLayout=e._isRandomItemLayout,s.customTimeScales=e._cts,s.customFormatScales=e._cfs,null==e.itemLayout||"auto"==e.itemLayout?s.isTopToBottom=e.inverted:s.isTopToBottom="topToBottom"==e.itemLayout,s.data=e._data,s},m.prototype.buildData=function(e){var t={},i=[],s=e.items;if(s)for(var r=0;r<s.length;r++){var n=s[r];i.push(n)}return t.data=i,t},m.prototype._parseDataNode=function(e,t,i,s,r,n){var a=new Array,o=e._series[t];if(i)for(var l=0;l<i.length;l++){var h=this.ParseNodeAttributes(i[l],r,n);if(h){if(o._allowUpdates){var _=this._findExistingItem(h,s);if(_){var c=s.indexOf(_);s.splice(c,1),_.setSpacing(null),_.setDurationLevel(null),_.setLoc(null),_.setSelected(!1),_.setStartTime(h.startTime),_.setEndTime(h.endTime),_.setStyle(h.style)}else(_=new g(e,t,h)).setSelectable(!0)}else(_=new g(e,t,h)).setSelectable(!0);for(var m=_.getStartTime(),u=!0,d=0;d<a.length;d++)if(m<a[d].getStartTime()){a.splice(d,0,_),u=!1;break}u&&a.push(_)}}return a},m.prototype._findExistingItem=function(t,i){if(i)for(var s=0;s<i.length;s++){var r=i[s];if(e.Obj.compareValues(this._context,t.id,r.getId())&&t.title==r.getTitle()&&t.desc==r.getDescription()&&t.thumbnail==r.getThumbnail())return r}},m.prototype.getDate=function(e){return null==e?null:e.getTime?e.getTime():isNaN(e)?new Date(e).getTime()+0:e},m.prototype.ParseNodeAttributes=function(e,t,i){var s=new Object;return s.id=e.id,s.rowKey=s.id,s.startTime=this.getDate(e.start),s.endTime=this.getDate(e.end),(s.endTime?s.endTime:s.startTime)<t||s.startTime>i?null:(s.title=e.title,s.desc=e.description,s.thumbnail=e.thumbnail,s.shortDesc=e.shortDesc,s.data=e,s.style=e.style,e.svgStyle&&(s.style=e.svgStyle),s.durationFillColor=e.durationFillColor,s.markerShape=e._markerShape,s.markerScaleX=e._markerScaleX,s.markerScaleY=e._markerScaleY,s.markerShortDesc=e._markerShortDesc,s.markerFillColor=e._markerFillColor,s.markerGradientFill=e._markerGradientFill,s.markerOpacity=e._markerOpacity,0==e._markerSD?s.markerSD="false":s.markerSD="true",s.data=e,s)};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var u=new Object;e.Obj.createSubclass(u,e.Obj),u.renderSeries=function(t,i,s){if(u._renderBackground(t,i,s),u._renderScrollableCanvas(t),u._renderReferenceObjects(t,t._canvas),u._renderSeriesTicks(t),null!=t._items){if(0==t._blocks.length){var r=t.getCtx(),n=new e.Container(r,"itemBlock_"+t._fetchStartPos+"_"+t._fetchEndPos);n.startPos=t._fetchStartPos,n.endPos=t._fetchEndPos;var a=new e.Container(r,"feelers");n.addChild(a),n.feelers=a;var o=new e.Container(r,"durations");n.addChild(o),n.durations=o,t._canvas.addChild(n),t._blocks.push(n)}else n=t._blocks[0];t.prepareDurations(t._items),t.prepareItems(t._items),t._isInitialRender?(t._isIRAnimationEnabled?t._frAnimationElems=[]:t._frAnimationElems=null,t._mvAnimator=null,t._rmAnimationElems=null):t._allowUpdates&&t._isDCAnimationEnabled?(t._frAnimationElems=[],t._mvAnimator=new e.Animator(t.getCtx(),l.getAnimationDuration(t.Options),0,e.Easing.cubicInOut),t._rmAnimationElems=[]):(t._frAnimationElems=null,t._mvAnimator=null,t._rmAnimationElems=null),t._hasMvAnimations=!1;var h=Math.max(0,t._maxOverflowValue-t._size);t._overflowOffset=h,u._adjustBackground(t,h),t._oldItems&&u._removeItems(t._oldItems,t,n,t._rmAnimationElems),t._oldItems=null,t.isVertical()&&n.feelers.removeChildren(),u._renderItems(t._items,t,n,t._fetchStartPos,t._fetchEndPos,h,t._frAnimationElems,t._mvAnimator),t._callbackObj.SelectionHandler&&n.setCursor(e.SelectionEffectUtils.getSelectingCursor()),u._updateReferenceObjects(t),u._updateSeriesTicks(t)}},u.updateSeriesForZoom=function(e){u._updateItemsForZoom(e._items,e),u._updateReferenceObjects(e),u._updateSeriesTicks(e)},u._renderBackground=function(t,i,s){if(t._background){var r=!1;t._background.setWidth(i),t._background.setHeight(s)}else r=!0,t._background=new e.Rect(t.getCtx(),0,0,i,s,"bg");t._background.setCSSStyle(t._style),t._background.setPixelHinting(!0),r&&t.addChild(t._background)},u._adjustBackground=function(t,i){var s=t.getCtx(),r=e.Agent.isRightToLeft(s);i>0&&(t.isVertical()?t._background.setWidth(t._maxOverflowValue):t._background.setHeight(t._maxOverflowValue)),t.isVertical()?(!t.isInverted()&&!r||t.isInverted()&&r)&&(t._background.setTranslateX(-i),t.setHScrollPos(i)):t.isInverted()||(t._background.setTranslateY(-i),t.setVScrollPos(i))},u._renderScrollableCanvas=function(t){if(t._canvas)return t._canvasOffsetX=t._canvas.getTranslateX(),t._canvasOffsetY=t._canvas.getTranslateY(),t._canvas.setTranslateX(0),void t._canvas.setTranslateY(0);t._canvas=new e.Container(t.getCtx(),"canvas"),t.addChild(t._canvas)},u._renderItems=function(t,i,s,r,n,a,o,l){for(var h=0;h<t.length;h++){var _=t[h],g=e.TimeAxis.getDatePosition(i._start,i._end,_.getStartTime(),i._length);g<r||g>n||c.renderItem(_,i,s,a,o,l)}if(e.TimeAxis.supportsTouch())for(h=0;h<t.length-1;h++){var m=(_=t[h]).getBubble();if(m){var d=t[h+1];if(!d.getBubble())break;m._setAriaProperty("flowto","_bt_"+d.getId())}}u._renderDurations(t,i,s,a,o,l)},u._updateItemsForZoom=function(t,i){if(null!=t&&0!=t.length){var s=i._fetchStartPos,r=i._fetchEndPos,n=i._blocks[0];n.startPos=s,n.endPos=r,i.isVertical()?i._initialSpacing=20*(i._maxDurationSize>0?1:0)+l.getBubbleSpacing()+10*i._maxDurationSize:i._initialSpacing=20+l.getBubbleSpacing()+10*i._maxDurationSize;for(var a=0;a<t.length;a++){var o=(S=t[a]).getStartTime(),h=e.TimeAxis.getDatePosition(i._start,i._end,o,i._length),_=S.getEndTime();if(_&&_!=o){var g=e.TimeAxis.getDatePosition(i._start,i._end,_,i._length)-h;h+=Math.min(l.getDurationFeelerOffset(),g/2)}S.setLoc(h),i._isRandomItemLayout||S.setSpacing(null)}for(a=0;a<t.length;a++){var m=(S=t[a]).getStartTime();m<i._start||m>i._end||c._updateBubble(S,i,a)}var d=Math.max(0,i._maxOverflowValue-i._size);u._adjustBackground(i,d);for(a=0;a<t.length;a++){var S=t[a];c._displayBubble(S,i,d,null,!1),c._updateFeeler(S,i,d,null),c._updateDuration(S,i,d,null)}}},u._renderDurations=function(e,t,i,s,r,n){for(var a=i.durations,o=t._maxDurationSize;o>0;o--)for(var l=0;l<e.length;l++){var h=e[l],_=h.getStartTime(),g=h.getEndTime();g&&g!=_&&o==h.getDurationLevel()&&c.renderDuration(h,t,a,s,r,n)}},u._renderSeriesTicks=function(t){if(null==t._seriesTicks?(t._seriesTicks=new e.Container(t.getCtx()),t._canvas.addChild(t._seriesTicks)):(t._seriesTicks.removeChildren(),t._seriesTicksArray=[]),t._scale&&t._timeAxis){var i=new e.CSSStyle(l.getSeriesAxisSeparatorStyle());if(t._axisStyleDefaults){var s=t._axisStyleDefaults.separatorColor;s&&i.parseInlineStyle("color:"+s+";")}t._separatorStroke=new e.Stroke(i.getStyle(e.CSSStyle.COLOR),1,1,!1,{dashArray:"3"}),u._renderSeriesTimeAxis(t,t._fetchStartPos,t._fetchEndPos,t._seriesTicks)}},u._updateSeriesTicks=function(t){for(var i=t.getCtx(),s=e.Agent.isRightToLeft(i),r=0;r<t._seriesTicksArray.length;r++){var n=t._seriesTicksArray[r];if(!t.isVertical()&&s)var a=t._length-e.TimeAxis.getDatePosition(t._start,t._end,n.time,t._length);else a=e.TimeAxis.getDatePosition(t._start,t._end,n.time,t._length);t.isVertical()?(n.setX1(0),n.setY1(a),n.setX2(t._maxOverflowValue),n.setY2(a)):(n.setX1(a),n.setY1(0),n.setX2(a),n.setY2(t._maxOverflowValue))}},u._renderSeriesTimeAxis=function(t,i,s,r){var n,a=t.getCtx(),o=e.Agent.isRightToLeft(a),l=t._start,h=t._end;if(t._customTimeScales&&t._customTimeScales[t._scale])n=t._customTimeScales[t._scale].times;else if(t._customFormatScales&&t._customFormatScales[t._scale]){n=t._customFormatScales[t._scale].times}else{n=[];var _=e.TimeAxis.getPositionDate(l,h,i,t._length),c=t._timeAxis.adjustDate(_),g=e.TimeAxis.getDatePosition(l,h,c,t._length);for(n.push(c.getTime());g<s;)c=t._timeAxis.getNextDate(c.getTime()),g=e.TimeAxis.getDatePosition(l,h,c,t._length),n.push(c.getTime())}for(var m=0;m<n.length-1;m++){var u=n[m];if(g=e.TimeAxis.getDatePosition(l,h,u,t._length),!t.isVertical()&&o)var d=t._length-g;else d=g;if(t.isVertical())var S=0,v=d,f=t._maxOverflowValue,p=d;else S=d,v=0,f=d,p=t._maxOverflowValue;var T=t.addTick(r,S,f,v,p,t._separatorStroke,"o_tick"+g);T.time=u,t._seriesTicksArray.push(T)}},u._renderReferenceObjects=function(t,i){var s=t.getCtx(),r=e.Agent.isRightToLeft(s);null==t._refObjectsContainer&&(t._refObjectsContainer=new e.Container(s),i.addChild(t._refObjectsContainer));var n=t._referenceObjects;if(n)for(var a=Math.min(1,n.length),o=0;o<a;o++){var h=n[o];if(h){var _=e.TimeAxis.getDatePosition(t._start,t._end,h,t._length);if(0==t._renderedReferenceObjects.length){if(t.isVertical())var c=new e.Line(s,0,_,t._maxOverflowValue,_,"zoomOrder[i]");else r&&(_=t._length-_),c=new e.Line(s,_,0,_,t._maxOverflowValue,"zoomOrder[i]");var g=new e.Stroke(l.getReferenceObjectColor(t.Options));c.setStroke(g),c.setPixelHinting(!0),c.date=h,t._refObjectsContainer.addChild(c),t._renderedReferenceObjects[o]=c}else(c=t._renderedReferenceObjects[o]).date=h,_=e.TimeAxis.getDatePosition(t._start,t._end,c.date,t._length),t.isVertical()?(c.setX1(0),c.setY1(_),c.setX2(t._maxOverflowValue),c.setY2(_)):(r&&(_=t._length-_),c.setX1(_),c.setY1(0),c.setX2(_),c.setY2(t._maxOverflowValue))}}else t._refObjectsContainer.removeChildren(),t._renderedReferenceObjects=[]},u._updateReferenceObjects=function(t){for(var i=t.getCtx(),s=e.Agent.isRightToLeft(i),r=0;r<t._renderedReferenceObjects.length;r++){var n=t._renderedReferenceObjects[r],a=e.TimeAxis.getDatePosition(t._start,t._end,n.date,t._length);t.isVertical()?(n.setX1(0),n.setY1(a),n.setX2(t._maxOverflowValue),n.setY2(a)):(s&&(a=t._length-a),n.setX1(a),n.setY1(0),n.setX2(a),n.setY2(t._maxOverflowValue))}},u._removeItems=function(e,t,i,s){if(s)u._animateItemRemoval(e,t,s);else for(var r=0;r<e.length;r++){var n=e[r],a=n.getBubble();if(i.removeChild(a),!t.isVertical()){var o=i.feelers,l=n.getFeeler();o.removeChild(l)}var h=n.getStartTime(),_=n.getEndTime();if(_&&_!=h){var c=i.durations,g=n.getDurationBar();c.removeChild(g)}}},u._animateItemRemoval=function(e,t,i){for(var s=0;s<e.length;s++){var r=e[s],n=r.getBubble();if(t.isVertical()?n.setTranslateX(n.getTranslateX()+t._canvasOffsetX+t._overflowOffset):n.setTranslateY(n.getTranslateY()+t._canvasOffsetY+t._overflowOffset),i.push(n),!t.isVertical()){var a=r.getFeeler();a.setTranslateY(a.getTranslateY()+t._canvasOffsetY+t._overflowOffset),i.push(a)}var o=r.getStartTime(),l=r.getEndTime();if(l&&l!=o){var h=r.getDurationBar();t.isVertical()?h.setTranslateX(h.getTranslateX()+t._canvasOffsetX+t._overflowOffset):h.setTranslateY(h.getTranslateY()+t._canvasOffsetY+t._overflowOffset),i.push(h)}}};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var d=new Object;e.Obj.createSubclass(d,e.Obj),d.getDatatipColor=function(e){var t=e.getDurationFillColor();return t||null},d.getDatatip=function(t,i,s){var r=t._timeline,n=r.getOptions().tooltip,a=n?n.renderer:null;if(i&&a){var o=r.getCtx().getTooltipManager(),l=t.getDataContext();return o.getCustomTooltip(a,l)}var h=t.getShortDesc();if(null!=h)return h;if(s&&!r.getCtx().isCustomElement()){var _=r.getOptions().translations,c=t.getStartTime(),g=r.getTimeAxis().formatDate(new Date(c),null,"general"),m=e.ResourceUtils.format(_.accessibleItemStart,[g]),u=t.getEndTime();if(u&&u!=c){var S=r.getTimeAxis().formatDate(new Date(u),null,"general");m=m+" "+e.ResourceUtils.format(_.accessibleItemEnd,[S])}var v=t.getTitle();v&&""!=v&&(m=m+" "+e.ResourceUtils.format(_.accessibleItemTitle,[v]));var f=t.getDescription();return f&&""!=f&&(m=m+" "+e.ResourceUtils.format(_.accessibleItemDesc,[f])),m}var p=[];return d._addItemDatatip(p,t,i),d._processDatatip(p,r,i)},d._processDatatip=function(t,i,s){return 0===t.length?null:s?e.HtmlTooltipManager.createElement("table",null,t,["oj-dvt-datatip-table"]):t.join("")},d._addItemDatatip=function(e,t,i){var s=t._timeline,r=t.getTitle();r&&d._addDatatipRow(e,s,"title","Title",r,i);var n=t.getDescription();n&&d._addDatatipRow(e,s,"description","Description",n,i);var a=t.getStartTime(),o=t.getEndTime();a&&o&&o!=a?(d._addDatatipRow(e,s,"start","Start",a,i),d._addDatatipRow(e,s,"end","End",o,i)):d._addDatatipRow(e,s,"date","Date",a,i);var l=t._series.getLabel();null==l&&(l=t._series.getId()),d._addDatatipRow(e,s,"series","Series",l,i)},d._addDatatipRow=function(t,i,s,r,n,a,o){if(null!=n&&""!==n){var l,h=i.getOptions().styleDefaults,_=d.getValueFormat(i,s),c=_.tooltipDisplay,g=i.getOptions().translations;if("off"!=c)if("string"==typeof _.tooltipLabel&&(l=_.tooltipLabel),null==l&&(l=null==r?"":g["label"+r]),n=d.formatValue(i,s,_,n),a){var m=[e.HtmlTooltipManager.createElement("td",h.tooltipLabelStyle,l,["oj-dvt-datatip-label"]),e.HtmlTooltipManager.createElement("td",h.tooltipValueStyle,n,["oj-dvt-datatip-value"])];t.push(e.HtmlTooltipManager.createElement("tr",null,m))}else t.push((t.length>0?"<br>":"")+e.ResourceUtils.format(g.labelAndValue,[l,n]))}},d.getValueFormat=function(e,t){var i=e.getOptions().valueFormats;if(!i)return{};if(i instanceof Array){for(var s={},r=0;r<i.length;r++){var n=i[r];s[n.type]=n}e.getOptions().valueFormats=s,i=s}return i[t]?i[t]:{}},d.formatValue=function(e,t,i,s){var r=i.converter;return"start"==t||"end"==t||"date"==t?e.getTimeAxis().formatDate(new Date(s),r,"general"):r&&r.format?r.format(s):s}}(dvt);
  return dvt;
});
