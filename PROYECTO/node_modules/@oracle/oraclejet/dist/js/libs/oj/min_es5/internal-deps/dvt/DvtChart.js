...
function _toConsumableArray(t){return _arrayWithoutHoles(t)||_iterableToArray(t)||_unsupportedIterableToArray(t)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var i=Object.prototype.toString.call(t).slice(8,-1);return"Object"===i&&t.constructor&&(i=t.constructor.name),"Map"===i||"Set"===i?Array.from(t):"Arguments"===i||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)?_arrayLikeToArray(t,e):void 0}}function _iterableToArray(t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(t))return Array.from(t)}function _arrayWithoutHoles(t){if(Array.isArray(t))return _arrayLikeToArray(t)}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var i=0,r=new Array(e);i<e;i++)r[i]=t[i];return r}function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}
/**
 * @license
...
/**
   ...
   * @ignore
   */
var s=function(t,e,i,r){this.id=t,this.series=e,this.group=i,this.context=r};t.Obj.createSubclass(s,t.Obj),s.prototype.equals=function(t){return t instanceof s&&(null!=this.id||null!=t.id?Q.isEqualId(this.id,t.id,this.context):Q.isEqualId(this.series,t.series,this.context)&&Q.isEqualId(this.group,t.group,this.context))},s.prototype.toString=function(){return null!=this.id&&"object"!==_typeof(this.id)?this.id.toString():Q.createDataItemId(this.series,this.group)},s.prototype.valueOf=function(){return this.toString()};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var h=function(){};t.Obj.createSubclass(h,t.BaseComponent),h.newInstance=function(t,e,i){var r=new h;return r.Init(t,e,i),r},h.getDefaults=function(t){return(new d).getDefaults(t)},h.prototype.Init=function(e,i,r){h.superclass.Init.call(this,e,i,r),this.Defaults=new d(e),this.EventManager=new c(this),this.EventManager.addListeners(this),t.Agent.isTouchDevice()||this.EventManager.setKeyboardHandler(new p(this.EventManager,this)),this._bounds=null},h.prototype.SetOptions=function(e){e?"off"!==e.rendered?this.Options=this.Defaults.calcOptions(e):(e.tickLabel.style=new t.CSSStyle(e.tickLabel.style),e.titleStyle=new t.CSSStyle(e.titleStyle),this.Options=e):this.Options||(this.Options=this.GetDefaults())},h.prototype.getPreferredSize=function(t,e,i,r){return this.SetOptions(t),_.getPreferredSize(this,e,i,r)},h.prototype.render=function(e,i,r,a,n){this.getCache().clearCache(),this.SetOptions(e),this._navigablePeers=[],this.Width=i,this.Height=r,this.removeChildren(),a||(a=0),n||(n=0);var s=new t.Rectangle(a,n,i,r);_.render(this,s)},h.prototype.__registerObject=function(t){(null!=t.getDatatip()||t.isDrillable())&&this._navigablePeers.push(t)},h.prototype.__getKeyboardObjects=function(){return this._navigablePeers},h.prototype.isNavigable=function(){return this._navigablePeers.length>0},h.prototype.getKeyboardFocus=function(){return null!=this.EventManager?this.EventManager.getFocus():null},h.prototype.setKeyboardFocus=function(e,i){if(null!=this.EventManager){for(var r=this.__getKeyboardObjects(),a=e.getId(),n=!1,s=0;s<r.length;s++){var o=r[s].getId();if(a instanceof Array&&o instanceof Array&&t.ArrayUtils.equals(a,o)||a===o){this.EventManager.setFocusObj(r[s]),n=!0,i&&r[s].showKeyboardFocusEffect();break}}n||this.EventManager.setFocusObj(this.EventManager.getKeyboardHandler().getDefaultNavigable(r));var l=this.getKeyboardFocus();if(l){var h=l.getDisplayable();h.setAriaProperty("label",l.getAriaLabel()),this.getCtx().setActiveElement(h)}}},h.prototype.processEvent=function(t,e){this===e&&this.dispatchEvent(t)},h.prototype.getInfo=function(){return this.Info},h.prototype.__setInfo=function(t){this.Info=t},h.prototype.getWidth=function(){return this.Width},h.prototype.getHeight=function(){return this.Height},h.prototype.__setBounds=function(t){this._bounds=t},h.prototype.__getBounds=function(){return this._bounds},h.prototype.getAutomation=function(){return new g(this)};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var u={};t.Obj.createSubclass(u,t.Obj),u.TICK_LABEL="tickLabel",u.TITLE="title";
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var I=function(t,e,i,r,a,n){this.x=t,this.y1=e,this.y2=i,this.groupIndex=r,this.group=a,this.filtered=n};t.Obj.createSubclass(I,t.Obj),I.prototype.isUpstep=function(t){return Math.abs(this.y2-t)>Math.abs(this.y1-t)},I.prototype.clone=function(){return new I(this.x,this.y1,this.y2,this.groupIndex,this.group,this.filtered)};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var E=function(t){this.Init(t.getCtx(),t.processEvent,t),this._parentChart=t,this._chart=t.overview?t.overview.getBackgroundChart():null,this._id=t.getId()+"_overview"};t.Obj.createSubclass(E,t.Overview),E.prototype._renderChart=function(e,i,r){var a=this._parentChart.Defaults.getNoCloneObject();this._chartContainer=new t.Container(this.getCtx()),this.addChild(this._chartContainer);e=t.JsonUtils.merge({legend:{rendered:"off",size:null},xAxis:{viewportMin:null,viewportMax:null,viewportStartGroup:null,viewportEndGroup:null,axisLine:{rendered:"off"},size:null,maxSize:.5,title:null},yAxis:{rendered:"off",size:null},y2Axis:{rendered:"off",size:null},splitDualY:"off",title:{text:null},subtitle:{text:null},footnote:{text:null},titleSeparator:{rendered:"off"},styleDefaults:{animationIndicators:"none"},layout:{outerGapWidth:0,outerGapHeight:0},_isOverview:!0},e,a),q.hasGroupAxis(this._parentChart)&&(e.xAxis.tickLabel.rendered="off"),at.isStock(this._parentChart)&&e.series&&e.series[0]&&(e.series=[e.series[0]],e.series[0].type="lineWithArea");var n=this._parentChart.getOptions().overview.content,s=(e=t.JsonUtils.merge(n,e,a)).yAxis.rendered,o=e.y2Axis.rendered;e.zoomAndScroll="off",this._chart||(this._chart=t.Chart.newInstance(this.getCtx()),this._chart.setId(this._id));var l=i,h=this._parentChart.getWidth(),u=this._parentChart.__getPlotAreaSpace(),g=at.hasY2Data(this._parentChart),d=at.hasY2DataOnly(this._parentChart),c=(s="on"===e.yAxis.rendered&&!d,o="on"===e.y2Axis.rendered&&g,u.x),p=h-(c+i);s&&(l=c+i,e.yAxis.size=c),o&&(l=(s?c:0)+p+i,e.y2Axis.size=p),this._chartContainer.addChild(this._chart),this._chart.render(e,l,r);var _=new t.Rect(this.getCtx(),0,0,l,r);_.setInvisibleFill(),this._chartContainer.addChild(_),this._chart.getEventManager().setKeyboardHandler(null);var f=this._chart.__getPlotAreaSpace();if(s){var v=this._chartContainer.getTranslateX()-f.x;this._chartContainer.setTranslateX(v)}return new t.Dimension(i,f.h+f.y)},E.prototype.render=function(t,e,i){t.overview.style={overviewBackgroundColor:"rgba(0,0,0,0)",windowBackgroundColor:"rgba(0,0,0,0)",windowBorderTopColor:"#333333",windowBorderRightColor:"#333333",windowBorderBottomColor:"#333333",windowBorderLeftColor:"#333333",leftFilterPanelColor:"rgba(5,65,135,0.1)",rightFilterPanelColor:"rgba(5,65,135,0.1)",handleBackgroundClass:t.chart._resources.overviewGrippy,handleSize:16,handleFillColor:"rgba(0,0,0,0)"},t.overview.animationOnClick="off";var r=this._renderChart(t.chart,e,i);E.superclass.render.call(this,t.overview,r.w,r.h)},E.prototype.destroy=function(){E.superclass.destroy.call(this),this._parentChart=null,this._chart=null},E.prototype.getBackgroundChart=function(){return this._chart},E.prototype.isBackgroundRendered=function(){return!1},E.prototype.isLeftAndRightFilterRendered=function(){return!0},E.prototype.HandleKeyDown=function(t){},E.prototype.HandleKeyUp=function(t){};
/**
   * @license
   * Copyright (c) 2011 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var B=function(t,e,i,r){this.Init(t,e,i,r)};B._THREED_TILT=.59,B._THREED_DEPTH=.1,B._RADIUS=.45,B._RADIUS_LABELS=.38,B._MIN_ARC_LENGTH=1.5,t.Obj.createSubclass(B,t.Container),B.prototype.Init=function(e,i,r,a){B.superclass.Init.call(this,e.getCtx()),this.chart=e,this._options=e.getOptions(),this._frame=i.clone(),e.pieChart=this;for(var n=this.getLabelPosition(),s=Q.getSeriesCount(e),o=0;o<s;o++){var l=Q.getDataItem(e,o,0);!l||"center"!=n&&"none"!=n||"outsideSlice"!=l.labelPosition||(n="outsideSlice")}this._center=new t.Point(i.x+Math.floor(i.w/2),i.y+Math.floor(i.h/2));var h="center"==n||"none"==n?B._RADIUS:B._RADIUS_LABELS;this._radiusX=Math.floor(Math.min(i.w,i.h)*h),this._radiusY=this._radiusX,this._depth=0,this._anchorOffset=90,this.is3D()&&(this._depth=i.h*B._THREED_DEPTH,this._center.y-=Math.floor(this._depth/2),this._radiusY*=B._THREED_TILT),this._slices=this._createSlices(),this._centerLabel=null,this._shapesContainer=new t.Container(this.getCtx()),this._numFrontObjs=0,this._numSelectedObjsInFront=0},B.prototype.getOptions=function(){return this._options},B.prototype.highlight=function(e){t.CategoryRolloverHandler.highlight(e,this._slices,"any"==this.getOptions().highlightMatch)},B.prototype._createSlices=function(){for(var e,i,r=[],a=st.getRenderedSeriesIndices(this.chart),n=st.getOtherValue(this.chart),s=0;s<a.length;s++)if(i=a[s],et.isDataItemRendered(this.chart,i)){var o=(e=new F(this,i)).getValue();null==o||o<=0||r.push(e)}var l=et.getHiddenCategories(this.chart).indexOf(st.OTHER_SLICE_SERIES_ID)>=0;if(n>0&&!l){var h=new F(this);"ascending"==this.chart.getOptions().sorting?r.unshift(h):r.push(h)}return t.Agent.isRightToLeft(this.getCtx())&&r.reverse(),r},B.prototype.setInitialSelection=function(){var t=this.chart.getSelectionHandler();if(t){for(var e=Q.getInitialSelection(this.chart),i=[],r=0;r<e.length;r++)for(var a=0;a<this._slices.length;a++){var n=this._slices[a].getId();null!=n&&(null!=e[r].id&&n.id==e[r].id||n.series==e[r].series&&n.group==e[r].group)&&i.push(n)}if(st.isOtherSliceSelected(this.chart,e)){var s=st.getOtherSliceId(this.chart);i.push(s)}t.processInitialSelections(i,this._slices)}},B.prototype.render=function(){J.addPlotAreaDnDBackground(this.chart,this,this._frame,!0),this.contains(this._shapesContainer)||(this._shapesContainer||(this._shapesContainer=new t.Container(this.getCtx())),this.addChild(this._shapesContainer)),B._layoutSlices(this._slices,this._anchorOffset);for(var e=2*Math.PI*this.getRadiusX(),i=0,r={},a=this.chart.getOptionsCache().getFromCache("hasLargeSeriesCount"),n=0;n<this._slices.length;n++){if(a){var s=this._slices[n].getAngleExtent(),o=s/360*e,l=(this._slices[n].getAngleStart()+s)/360*e;if(o<B._MIN_ARC_LENGTH&&Math.abs(i-l)<B._MIN_ARC_LENGTH){r[this._slices[n].getSeriesIndex()]=!0;continue}i=l}this._slices[n].preRender()}var h=B._orderSlicesForRendering(this._slices);this._duringDisplayAnim||(ht.createPieCenter(this),ht.layoutLabelsAndFeelers(this));for(n=0;n<h.length;n++)r[h[n].getSeriesIndex()]||h[n].render(this._duringDisplayAnim);this.setInitialSelection(),this.highlight(et.getHighlightedCategories(this.chart))},B.prototype.getTotalValue=function(){for(var t=0,e=0;e<this._slices.length;e++){var i=this._slices[e].getValue();i>=0&&(t+=i)}return t},B._layoutSlices=function(t,e){var i,r,a=0,n=t?t.length:0;e>360&&(e-=360),e<0&&(e+=360);var s=0;n>0&&(s=t[0].getPieChart().getTotalValue());for(var o=0;o<n;o++){var l=(i=t[o]).getValue();(r=e-(a=3.6*(l==s?100:0==s?0:Math.min(l/s*100,99.99))))<0&&(r+=360),i.setAngleStart(r),i.setAngleExtent(a),e=i.getAngleStart()}},B._orderSlicesForRendering=function(t){for(var e,i,r,a,n=[],s=t?t.length:0,o=-1,l=0;l<s;l++)if((r=(i=(e=t[l]).getAngleStart())+e.getAngleExtent())>360&&(r-=360),r<0&&(r+=360),90==r||i<90&&r>90){o=l,a=r-90;break}var h=[];for(l=o;l<s;l++)h.push(t[l]);for(l=0;l<o;l++)h.push(t[l]);var u=0,g=0,d=180+a;for(l=0;l<s;l++)if(e=h[l]){if(u+e.getAngleExtent()>d){g=l;break}n.push(e),u+=e.getAngleExtent()}for(l=s-1;l>=g;l--)(e=h[l])&&n.push(e);return n},B.prototype.is3D=function(){return"on"==this._options.styleDefaults.threeDEffect},B.prototype.__calcMaxExplodeDistance=function(){var t=.5/B._RADIUS-1;return this._radiusX*t},B.prototype.getAnimationDuration=function(){return et.getAnimationDuration(this.chart)},B.prototype.getDisplayAnimation=function(){this._duringDisplayAnim=!0;var e=new t.DataAnimationHandler(this.getCtx(),this),i=this.getAnimationDuration(),r=F.createFillerSlice(this,this.getTotalValue());this._slices.push(r);var a=new t.CustomAnimation(this.getCtx(),r,i);a.getAnimator().addProp(t.Animator.TYPE_NUMBER_ARRAY,r,r.GetAnimationParams,r.SetAnimationParams,r.getDeletedAnimationParams()),a.setOnEnd(r._removeDeletedSlice,r),e.add(a,0);for(var n=0;n<this._slices.length-1;n++)this._slices[n].animateInsert(e);var s=new t.CustomAnimation(this.getCtx(),this,i);s.getAnimator().addProp(t.Animator.TYPE_NUMBER_ARRAY,this,this._getAnimationParams,this._setAnimationParams,this._getAnimationParams()),e.add(s,0);var o=[];for(n=0;n<this._slices.length;n++)o=o.concat(this._slices[n].getLabelAndFeeler());var l=new t.AnimFadeIn(this._context,o,i);e.add(l,0),this._setAnimationParams();var h=e.getAnimation(!0);return h.setOnEnd(this._onEnd,this),h},B.prototype._onEnd=function(){this._duringDisplayAnim=!1,this._setAnimationParams()},B.prototype.getCenter=function(){return this._center},B.prototype.getId=function(){return"chart/pie"},B.prototype.getInnerRadius=function(){return this.is3D()?0:this._options.styleDefaults.pieInnerRadius*Math.min(this._radiusX,this._radiusY)*.95},B.prototype.__getFrame=function(){return this._frame},B.prototype.getRadiusX=function(){return this._radiusX},B.prototype.getRadiusY=function(){return this._radiusY},B.prototype.getDepth=function(){return this._depth},B.prototype.getSliceDisplayable=function(t){var e=st.getSliceBySeriesIndex(this.chart,t);return e?e.getTopDisplayable():null},B.prototype.__getShapesContainer=function(){return this._shapesContainer},B.prototype.__getSlices=function(){return this._slices},B.prototype.animateUpdate=function(e,i){var r=new t.DataAnimationHandler(this.getCtx(),this);r.constructAnimation(i.__getSlices(),this.__getSlices());var a=r.getAnimation(!0),n=new t.CustomAnimation(this.getCtx(),this,this.getAnimationDuration());n.getAnimator().addProp(t.Animator.TYPE_NUMBER_ARRAY,this,this._getAnimationParams,this._setAnimationParams,this._getAnimationParams());var s=new t.ParallelPlayable(this.getCtx(),a,n);s.setOnEnd(this._setAnimationParams,this),e.add(s,0),this._setAnimationParams([i.getDepth(),i.getRadiusY(),i.getCenter().y])},B.prototype.animateInsert=function(t){},B.prototype.animateDelete=function(t,e){},B.prototype._getAnimationParams=function(){return[this._depth,this._radiusY,this._center.y]},B.prototype._setAnimationParams=function(t){this.removeChildren(),this._shapesContainer&&this._shapesContainer.destroy(),this._shapesContainer=null,t&&(this._depth=t[0],this._radiusY=t[1],this._center.y=t[2]),this.render()},B.prototype.bringToFrontOfSelection=function(t){var e=t.getPieChart()._shapesContainer;if(e){var i=e.getNumChildren();if(i-this._numFrontObjs>1){e.removeChild(t._topSurface[0]);var r=i-this._numFrontObjs-1;e.addChildAt(t._topSurface[0],r)}}},B.prototype.pushToBackOfSelection=function(t){for(var e=this._slices.length,i=0,r=0;r<e;r++)this._slices[r].isSelected()&&i++;this._numSelectedObjsInFront=i;var a=t.getPieChart()._shapesContainer;if(a){var n=a.getNumChildren()-this._numFrontObjs-1-this._numSelectedObjsInFront;n>=0&&(a.removeChild(t._topSurface[0]),a.addChildAt(t._topSurface[0],n))}},B.prototype.getLabelPosition=function(){return B.parseLabelPosition(this._options.styleDefaults.dataLabelPosition)},B.prototype.getSeriesLabelPosition=function(t){var e=this.getLabelPosition(),i=Q.getDataItem(this.chart,t,0);return i&&i.labelPosition&&(e=i.labelPosition),B.parseLabelPosition(e)},B.parseLabelPosition=function(t){return"center"==t||"inside"==t?"center":"outsideSlice"==t||"outside"==t?"outsideSlice":"none"==t?"none":"auto"},B.prototype.getSkin=function(){return this._options.skin},B.prototype.setCenterLabel=function(t){this._centerLabel=t},B.prototype.getCenterLabel=function(){return this._centerLabel};
/**
   * @license
   * Copyright (c) 2008 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var H=function(){};t.Obj.createSubclass(H,t.Obj),H.createAnimation=function(e,i,r,a,n){if(!H._canAnimate(e,i))return null;var s,o=i.getCtx(),l=[],h=[];at.isPie(i)?(l.push(e.pieChart),h.push(i.pieChart)):H._buildAnimLists(o,l,e,h,i,a);var u=new t.DataAnimationHandler(o,n);u.constructAnimation(l,h),u.getNumPlayables()>0&&(s=u.getAnimation(!0));var g=i.getDataLabels();if(s&&g.length>0){for(var d=0;d<g.length;d++)g[d].setAlpha(0);s=new t.SequentialPlayable(o,s,new t.AnimFadeIn(o,g,a/4))}return s},H._buildAnimLists=function(e,i,r,a,n,s){var o,l,h,u,g,d=r.getChartObjPeers(),c=i,p=n.getCache().getFromCache("dataFiltered");for(o=0;o<2;o++){var _={},f={};for(l=0;l<d.length;l++){if(g=null,(u=(h=d[l]).getDisplayables()[0])instanceof R)g=new K(h,s);else if(u instanceof k)g=new Z(h,s);else if(u instanceof b||u instanceof P){if(g=new V(h,s),p){var v=h.getSeries();_[v]=_[v]?_[v]+1:1,g.setId(v+"/"+_[v]+"/bar")}}else if(u instanceof O){var m=(g=new Y(h,s)).getId();f[m]=f[m]?f[m]+1:1,g.setId(m+"/"+f[m])}else if(u instanceof t.SimpleMarker){if(u instanceof D&&!u.isSelected())continue;g=new W(h,s)}else if(u instanceof L){if(u.isInvisible()&&!u.isSelected())continue;g=new z(h,s)}else u instanceof T?g=new U(h,s):u instanceof M&&(g=new j(h,s));g&&(c.push(g),g.setOldChart(r))}c=a,d=n.getChartObjPeers()}},H._canAnimate=function(t,e){return at.isPie(t)&&at.isPie(e)?t&&e:at.isPolar(t)==at.isPolar(e)&&(!(!at.isBLAC(t)||!at.isBLAC(e))||(!(!at.isScatterBubble(t)||!at.isScatterBubble(e))||t.getType()==e.getType()))};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var G=function(e){this.Options=e.Options,this.Peers=e.Peers,this.SeriesStyleArray=e.SeriesStyleArray,this.Cache=e.Cache,this.pieChart=e.pieChart,this._optionsCache=new t.BaseComponentCache,this._cache=new t.BaseComponentCache};t.Obj.createSubclass(G,t.Chart),G.prototype.getCache=function(){return this._cache},G.prototype.getOptionsCache=function(){return this._optionsCache};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var j=function(t,e){this.Init(t,e)};t.Obj.createSubclass(j,U),j.prototype.Init=function(t,e){j.superclass.Init.call(this,t,e),this._animId+="/boxAndWhisker"};
/**
   * @license
   * Copyright (c) 2008 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var Z=function(t,e){this.Init(t,e)};t.Obj.createSubclass(Z,U),Z.prototype.animateUpdate=function(e,i){var r=this._shape,a=i._shape.getAnimationParams(),n=r.getAnimationParams(),s=i._shape.getPrimaryFill(),o=this._shape.getPrimaryFill();if(!t.ArrayUtils.equals(a,n)||!s.equals(o)){r.setAnimationParams(a);var l=new t.CustomAnimation(r.getCtx(),this,this._updateDuration);l.getAnimator().addProp(t.Animator.TYPE_NUMBER_ARRAY,r,r.getAnimationParams,r.setAnimationParams,n),s.equals(o)||(this._shape.setFill(s),l.getAnimator().addProp(t.Animator.TYPE_FILL,r,r.getFill,r.setFill,o)),e.add(l,1)}},Z.prototype.animateInsert=function(e){var i=this._shape,r=i.getAnimationParams(),a=r.slice(0);a[1]=0,a[2]=0,i.setAnimationParams(a);var n=new t.CustomAnimation(i.getCtx(),this,this._insertDuration);n.getAnimator().addProp(t.Animator.TYPE_NUMBER_ARRAY,i,i.getAnimationParams,i.setAnimationParams,r),e.add(n,2)},Z.prototype.animateDelete=function(e,i){var r=this._shape;i.setClipPath(null),i.addChild(r);var a=r.getAnimationParams().slice(0);a[1]=0,a[2]=0;var n=new t.CustomAnimation(r.getCtx(),this,this._deleteDuration);n.getAnimator().addProp(t.Animator.TYPE_NUMBER_ARRAY,r,r.getAnimationParams,r.setAnimationParams,a),e.add(n,0)},Z.prototype.Init=function(t,e){Z.superclass.Init.call(this,t,e),this._animId+="/pyramid"};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var $=new Object;t.Obj.createSubclass($,t.Obj),$.getRefObjs=function(t){var e=$.getAxisRefObjs(t,"x"),i=$.getAxisRefObjs(t,"y"),r=$.getAxisRefObjs(t,"y2");return e.concat(i,r)},$.getAxisRefObjs=function(t,e){var i=t.getOptions();return i&&i[e+"Axis"]&&i[e+"Axis"].referenceObjects?i[e+"Axis"].referenceObjects:[]},$.getType=function(t){return"area"==t.type?"area":"line"},$.getLocation=function(t){return"front"==t.location?"front":"back"},$.getColor=function(t){return t.color?t.color:"#333333"},$.getLineWidth=function(t){return t.lineWidth?t.lineWidth:1},$.getLineType=function(t){return t.lineType?t.lineType:"straight"},$.isObjectRendered=function(e,i){var r=et.getHiddenCategories(e);if(r.length>0){var a=$.getRefObjCategories(i);if(a&&t.ArrayUtils.hasAnyItem(r,a))return!1}return!("hidden"==i.visibility)},$.getId=function(t){return null!=t.id?t.id:t.text},$.getRefObjCategories=function(t){return t.categories?t.categories:[$.getId(t)]},$.getRefObj=function(t,e){for(var i=$.getRefObjs(t),r=0;r<i.length;r++)if($.getId(i[r])==e)return i[r]},$.getLowValue=function(t){return null==t?null:t.low},$.getHighValue=function(t){return null==t?null:t.high},$.getXValue=function(t,e,i){return Q.getXValueFromItem(t,e[i],i)},$.getViewportMinMaxIndex=function(t,e){var i=q.getXAxisViewportMinMax(t,!0),r=q.hasGroupAxis(t),a=i.min,n=0;if(null!=a)if(r)n=Math.ceil(a);else for(var s=0;s<e.length;s++){if($.getXValue(t,e,s)>=a){n=s;break}}var o=i.max,l=e.length-1;if(null!=l)if(r)l=Math.floor(o);else for(s=e.length-1;s>=n;s--){if(Q.getXValue(t,e,s)<=o){l=s;break}}return{min:n,max:l}};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var it=new Object;t.Obj.createSubclass(it,t.Obj),it.createText=function(e,i,r,a,n,s,o,l){var h=new t.OutputText(i.getCtx(),r,n,s);return h.setCSSStyle(a),t.TextUtils.fitText(h,o,l,i)?(e.associate(h,new t.SimpleObjPeer(h.getUntruncatedTextString())),h):null},it.areTitlesRendered=function(t){var e=t.getOptions();return e.title.text||e.subtitle.text||e.footnote.text};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var nt=new Object;t.Obj.createSubclass(nt,t.Obj),nt._MIN_BUBBLE_SIZE=6,nt._MAX_BUBBLE_SIZE_RATIO=.5,nt.calcBubbleSizes=function(e,i){for(var r,a,n=Q.getMinMaxValue(e,"z"),s=n.min,o=n.max,l=nt._MIN_BUBBLE_SIZE,h=nt._MAX_BUBBLE_SIZE_RATIO*Math.min(i.w,i.h),u=Q.getSeriesCount(e),g="withoutRescale"==J.getHideAndShowBehavior(e),d=0;d<u;d++)if(g||et.isSeriesRendered(e,d))for(var c=Q.getSeriesItem(e,d),p=c.items?c.items.length:0,_=0;_<p;_++){var f=c.items[_];if(f){var v=t.LayoutUtils.getBubbleSize(f.z,s,o,l,h);f.markerSize=v}}at.isPolar(e)?(r=1/0,a=e.getRadius()):(r=i.w-2.4*q.getTickLabelHeight(e,"y"),a=i.h-1.6*q.getTickLabelHeight(e,"x")),r-=.5*h,a-=.5*h;var m=e.getCache(),S=nt._getAxisValueRange(e,"x");m.putToCache("_xAxisBubbleRatio",S/r);var y=nt._getAxisValueRange(e,"y");m.putToCache("_yAxisBubbleRatio",y/a)},nt.getBubbleAxisRadius=function(t,e,i){if(!i)return 0;var r="x"==e?"_xAxisBubbleRatio":"_yAxisBubbleRatio";return i/2*t.getCache().getFromCache(r)},nt._getAxisValueRange=function(e,i){var r=e.getOptions()[i+"Axis"],a=q.isLog(e,i),n=!a&&"zero"==q.getBaselineScaling(e,i),s=Q.getMinMaxValue(e,i,!0),o=r.min;null==o&&(o=n?Math.min(0,s.min):s.min);var l=r.max;return null==l&&(l=n?Math.max(0,s.max):s.max),a&&l>0&&o>0?l==o?6:t.Math.log10(l/o):l==o?60:l-o},nt.sortMarkers=function(t){t.sort(nt._compareSize)},nt.sortMarkerInfos=function(t){t.sort(nt._compareInfoSize)},nt._compareSize=function(t,e){return e.getSize()-t.getSize()},nt._compareInfoSize=function(t,e){return e.size-t.size},nt.checkPixelMap=function(t,e,i,r){var a=r/2,n=Math.max(Math.floor(e-a),0),s=Math.max(Math.floor(i-a),0),o=Math.max(Math.ceil(e+a),0),l=Math.max(Math.ceil(i+a),0);return t.isObscured(n,s,o,l)},nt.updatePixelMap=function(t,e,i,r,a){var n=.4*r,s=Math.max(Math.round(e-n),0),o=Math.max(Math.round(e+n),0),l=Math.max(Math.round(i-n),0),h=Math.max(Math.round(i+n),0);t.obscure(s,l,o,h,a)};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var ut=new Object;t.Obj.createSubclass(ut,t.Obj),ut._BUTTON_SIZE=16,ut._BUTTON_PADDING=5,ut._BUTTON_CORNER_DIST=4,ut._BUTTON_OPACITY=.8,ut._MOUSE_WHEEL_ZOOM_RATE_SLOW=.05,ut._MOUSE_WHEEL_ZOOM_RATE_FAST=.2,ut.render=function(t,e,i){if(ut._renderBackground(t,e,i),Q.hasInvalidData(t))ut.renderEmptyText(t,e,i);else{at.isOverview(t)||(t.getOptions()._maxOverflowCoord=i.x+i.w,t.getOptions()._minOverflowCoord=i.x),ut._addOuterGaps(t,i);var r=i.clone();ut._renderTitles(t,e,i),ut._adjustAvailSpace(i),dt.render(t,e,i),ut._adjustAvailSpace(i);var a=ut._prerenderHorizScrollbar(t,e,i),n=ut._prerenderVertScrollbar(t,e,i);ut._adjustAvailSpace(i),t.__setAxisSpace(i.clone()),gt.render(t,e,i),ut._adjustAvailSpace(i),ut._positionLegend(t.legend,i),t.__setPlotAreaSpace(i.clone()),ut._setEventHandlers(t),ut._renderScrollbars(t,a,n),ut._updateTitles(t,e,r,i),ut._renderPlotArea(t,e,i),ut._renderDragButtons(t,e)}},ut._setEventHandlers=function(e){var i=e.getOptions(),r=e.getEventManager();if(at.hasAxes(e)&&!at.isOverview(e)){var a,n,s=new t.Rectangle(0,0,e.getWidth(),e.getHeight()),o=e.__getPlotAreaSpace(),l=e.__getAxisSpace(),h=new t.Rectangle(o.x,l.y,o.w,l.h),u=new t.Rectangle(l.x,o.y,l.w,o.h),g=new t.SolidFill(i.styleDefaults.marqueeColor),d=new t.Stroke(i.styleDefaults.marqueeBorderColor);if(J.isScrollable(e)){var c=J.isDelayedScroll(e)?ut._MOUSE_WHEEL_ZOOM_RATE_FAST:ut._MOUSE_WHEEL_ZOOM_RATE_SLOW;if(n=new t.PanZoomHandler(e,o,s,c),r.setPanZoomHandler(n),J.isZoomable(e)){var p=J.getZoomDirection(e);a=at.isHorizontal(e)||"y"==p?new t.MarqueeHandler(e,o,s,g,d,!1,!0,null,u):at.isBLAC(e)||"x"==p?new t.MarqueeHandler(e,o,s,g,d,!0,!1,h,null):new t.MarqueeHandler(e,o,s,g,d,!0,!0,h,u),r.setMarqueeZoomHandler(a)}}"multiple"==i.selectionMode&&(a=new t.MarqueeHandler(e,o,s,g,d,!0,!0,h,u),r.setMarqueeSelectHandler(a))}},ut.rerenderAxisAndPlotArea=function(t,e){if(!Q.hasInvalidData(t)){var i=t.__getAxisSpace().clone(),r=t.getSelectionHandler();if(r)var a=r.getSelectedIds();var n=t.__cacheChartFocus();t.__cleanUpAxisAndPlotArea(),gt.render(t,e,i),ut._adjustAvailSpace(i),t.__setPlotAreaSpace(i.clone()),ut._renderPlotArea(t,e,i),r&&r.processInitialSelections(a,t.getChartObjPeers()),t.getEventManager().autoToggleZoomButton(),ut.positionDragButtons(t),t.highlight(et.getHighlightedCategories(t)),t.__restoreChartFocus(n)}},ut._renderBackground=function(e,i,r){var a=new t.Rect(e.getCtx(),r.x,r.y,r.w,r.h);a.setInvisibleFill(),i.addChild(a)},ut._addOuterGaps=function(t,e){var i=t.getOptions(),r=o.getGapWidth(t,i.layout.outerGapWidth),a=o.getGapHeight(t,i.layout.outerGapHeight);ut._needsOuterGaps(t)||(r=Math.min(r,1),a=Math.min(a,1)),e.x+=r,e.w-=2*r,e.y+=a,e.h-=2*a},ut._needsOuterGaps=function(t){var e=t.getOptions();return!(!at.isFunnel(t)||"on"!==e.styleDefaults.threeDEffect)||!(at.isStandalonePlotArea(t)||at.isStandaloneXAxis(t)||at.isStandaloneYAxis(t)||at.isStandaloneY2Axis(t))},ut._renderTitles=function(e,i,r){var a=e.getOptions();if(a.title.text){var n,s,l=it.createText(e.getEventManager(),i,a.title.text,a.title.style,r.x,r.y,r.w,r.h),h=null!=a.title.hAlign?a.title.hAlign:a.title.halign,u="plotArea"==h.substring(0,8);if(l?(n=(s=l.getDimensions()).h,l.setAriaProperty("hidden",null)):(n=0,s=new t.Rectangle(0,0,0,0)),a.subtitle.text){var g=new t.OutputText(e.getCtx(),a.subtitle.text,r.x,r.y);if(g){g.setCSSStyle(a.subtitle.style),i.addChild(g);var d=g.getDimensions(),c=o.getGapWidth(e,a.layout.titleSubtitleGapWidth),p=s.w+c+d.w;if(p>r.w||u)c=o.getGapHeight(e,a.layout.titleSubtitleGapHeight),g.setY(r.y+n+c),t.TextUtils.fitText(g,r.w,r.h,i)&&(n+=(d=g.getDimensions()).h+c,t.Agent.isRightToLeft(e.getCtx())&&(g&&g.setX(r.w-d.w),l&&l.setX(r.w-s.w)));else{var _=s.h-d.h;g.setY(_+r.y),l&&(t.LayoutUtils.align(r,h,l,p),t.Agent.isRightToLeft(e.getCtx())?(g.setX(l.getX()),l&&l.setX(l.getX()+d.w+c)):g.setX(l.getX()+p-d.w))}g.setAriaProperty("hidden",null),e.getEventManager().associate(g,new t.SimpleObjPeer(g.getUntruncatedTextString()))}}else t.LayoutUtils.align(r,h,l,s.w);u&&(e.getCache().putToCache("title",l),e.getCache().putToCache("subtitle",g));var f="on"==a.titleSeparator.rendered?a.layout.titleSeparatorGap:a.layout.titlePlotAreaGap;if(r.y+=n+o.getGapHeight(e,f),r.h-=n+o.getGapHeight(e,f),"on"==a.titleSeparator.rendered){var v=new t.Line(e.getCtx(),r.x,r.y,r.x+r.w,r.y),m=new t.Line(e.getCtx(),r.x,r.y+1,r.x+r.w,r.y+1);v.setSolidStroke(a.titleSeparator.upperColor),m.setSolidStroke(a.titleSeparator.lowerColor),i.addChild(v),i.addChild(m);var S=2+o.getGapHeight(e,a.layout.titlePlotAreaGap);r.y+=S,r.h-=S}}if(a.footnote.text){var y=it.createText(e.getEventManager(),i,a.footnote.text,a.footnote.style,r.x,0,r.w,r.h),C=null!=a.footnote.hAlign?a.footnote.hAlign:a.footnote.halign,x="plotArea"==C.substring(0,8);if(y){var A=y.getDimensions();y.setY(r.y+r.h-A.h),r.h-=A.h+o.getGapHeight(e,a.layout.footnoteGap),t.LayoutUtils.align(r,C,y,A.w),y.setAriaProperty("hidden",null)}x&&e.getCache().putToCache("footnote",y)}},ut._updateTitles=function(t,e,i,r){var a=t.getOptions(),n=null!=a.title.hAlign?a.title.hAlign:a.title.halign,s=null!=a.footnote.hAlign?a.footnote.hAlign:a.footnote.halign,o=a.title.text&&"plotArea"==n.substring(0,8),l=a.footnote.text&&"plotArea"==s.substring(0,8);if(i.x=r.x,i.w=r.w,o){var h,u=t.getCache().getFromCache("title"),g=t.getCache().getFromCache("subtitle"),d=u.getDimensions();ut._alignTextToPlotArea(e,i,n,u,d.w),g&&(h=g.getDimensions(),ut._alignTextToPlotArea(e,i,n,g,h.w))}if(l){var c=t.getCache().getFromCache("footnote"),p=c.getDimensions();ut._alignTextToPlotArea(e,i,s,c,p.w)}},ut._alignTextToPlotArea=function(e,i,r,a,n){t.TextUtils.fitText(a,i.w,i.h,e)&&("plotAreaStart"==r?t.LayoutUtils.align(i,"start",a,n):"plotAreaCenter"==r?t.LayoutUtils.align(i,"center",a,n):"plotAreaEnd"==r&&t.LayoutUtils.align(i,"end",a,n))},ut._renderPlotArea=function(e,i,r){if(at.hasAxes(e)){var a=new t.Container(e.getCtx());a.setTranslate(r.x,r.y),i.addChildAt(a,1),e.setPlotArea(a),e.getEventManager().associate(a,new t.SimpleObjPeer(null,null,null,{type:"plotArea"}));var n=new t.Rectangle(0,0,r.w,r.h);ct.render(e,a,n)}else if(at.isPie(e)){var s=new B(e,r);s.__getSlices().length>0?(i.addChild(s),e.setPlotArea(s),s.render()):ut.renderEmptyText(e,i,r)}else at.isFunnel(e)?pt.render(e,i,r):at.isPyramid(e)&&_t.render(e,i,r);r.w=0,r.h=0},ut.renderEmptyText=function(e,i,r){var a=e.getOptions();if(Q.hasInvalidTimeData(e)&&Q.hasData(e))var n=a.translations.labelInvalidData;else(n=a.emptyText)||(n=a.translations.labelNoData);t.TextUtils.renderEmptyText(i,n,new t.Rectangle(r.x,r.y,r.w,r.h),e.getEventManager(),a._statusMessageStyle)},ut._prerenderHorizScrollbar=function(e,i,r){var a=r.w,n=0;return J.isScrollable(e)&&at.isHorizScrollbarSupported(e)?et.isOverviewRendered(e)?(n=Math.min(et.getOverviewHeight(e),r.h))>0&&(e.overview=new E(e),i.addChild(e.overview),t.LayoutUtils.position(r,"bottom",e.overview,a,n,10)):(n=e.getOptions().styleDefaults._scrollbarHeight,e.xScrollbar=new t.SimpleScrollbar(e.getCtx(),e.processEvent,e),i.addChild(e.xScrollbar),t.LayoutUtils.position(r,"bottom",e.xScrollbar,a,n,8),e.overview=null):e.overview=null,new t.Dimension(a,n)},ut._prerenderVertScrollbar=function(e,i,r){var a=0,n=r.h;if(J.isScrollable(e)&&at.isVertScrollbarSupported(e)){a=e.getOptions().styleDefaults._scrollbarHeight;var s=new t.SimpleScrollbar(e.getCtx(),e.processEvent,e);i.addChild(s),t.LayoutUtils.position(r,t.Agent.isRightToLeft(e.getCtx())?"right":"left",s,a,n,8),at.isHorizontal(e)?e.xScrollbar=s:e.yScrollbar=s}return new t.Dimension(a,n)},ut._renderScrollbars=function(e,i,r){var a=e.getOptions(),n={color:a.styleDefaults._scrollbarHandleColor,backgroundColor:a.styleDefaults._scrollbarTrackColor},s=e.__getPlotAreaSpace();if(e.xScrollbar&&(n.min=e.xAxis.getLinearGlobalMin(),n.max=e.xAxis.getLinearGlobalMax(),at.isHorizontal(e)?(n.isHorizontal=!1,n.isReversed=!1,e.xScrollbar.setTranslateY(s.y),e.xScrollbar.render(n,r.w,s.h)):(n.isHorizontal=!0,n.isReversed=t.Agent.isRightToLeft(e.getCtx()),e.xScrollbar.setTranslateX(s.x),e.xScrollbar.render(n,s.w,i.h)),e.xScrollbar.setViewportRange(e.xAxis.getLinearViewportMin(),e.xAxis.getLinearViewportMax())),e.yScrollbar&&(n.min=e.yAxis.getLinearGlobalMin(),n.max=e.yAxis.getLinearGlobalMax(),n.isHorizontal=!1,n.isReversed=!0,e.yScrollbar.setTranslateY(s.y),e.yScrollbar.render(n,r.w,s.h),e.yScrollbar.setViewportRange(e.yAxis.getLinearViewportMin(),e.yAxis.getLinearViewportMax())),e.overview){var o=e.Defaults.getNoCloneObject(),l={overview:{xMin:e.xAxis.getLinearGlobalMin(),xMax:e.xAxis.getLinearGlobalMax(),x1:e.xAxis.getLinearViewportMin(),x2:e.xAxis.getLinearViewportMax(),minimumWindowSize:e.xAxis.getInfo().getMinimumExtent()},chart:t.JsonUtils.clone(a,null,o)};J.isZoomable(e)||(l.featuresOff="zoom"),l.chart._minOverflowCoord=a._minOverflowCoord-s.x,l.chart._maxOverflowCoord=a._maxOverflowCoord-s.x,e.overview.setTranslateX(s.x),e.overview.render(l,s.w,i.h),e.overview.setViewportRange(e.xAxis.getLinearViewportMin(),e.xAxis.getLinearViewportMax())}},ut._positionLegend=function(t,e){if(t){var i=t.getDimensions(),r=t.getOptions().orientation;"vertical"==r&&i.h<=e.h?t.setTranslateY(Math.round(e.y+e.h/2-i.h/2)):"horizontal"==r&&i.w<=e.w&&t.setTranslateX(Math.round(e.x+e.w/2-i.w/2))}},ut._renderDragButtons=function(e,r){var a=ut._BUTTON_SIZE+2*(ut._BUTTON_PADDING+ut._BUTTON_CORNER_DIST),n=e.__getPlotAreaSpace();if(!(!at.hasAxes(e)||at.isOverview(e)||n.w<a||n.h<a)){var s=e.getOptions(),o=s._resources,l=s.translations,h=e.getEventManager(),u=s.dragMode;if("user"==u){var g,d,c,p=t.Agent.isTouchDevice(),_=J.isScrollable(e);e.dragButtons=new t.Container(e.getCtx());var f=[],v="multiple"==s.selectionMode&&(p||_),m=_&&p,S=_&&!p&&J.isZoomable(e)&&at.isScatterBubble(e);v&&o.select&&f.push(o.select),m&&o.pan&&f.push(o.pan),S&&o.zoom&&f.push(o.zoom),c=t.ToolkitUtils.getIconStyles(e.getCtx(),f),v&&(d=m||S?"end":"solo",h.selectButton=ut._createDragButton(e,e.dragButtons,c[o.select],h.onSelectButtonClick,h,d),g=l.tooltipSelect,h.selectButton.setTooltip(g),h.associate(h.selectButton,h.selectButton)),m&&(d=v?"start":"solo",h.panButton=ut._createDragButton(e,e.dragButtons,c[o.pan],h.onPanButtonClick,h,d),g=l.tooltipPan,h.panButton.setTooltip(g),h.associate(h.panButton,h.panButton)),S&&(d=v?"start":"solo",h.zoomButton=ut._createDragButton(e,e.dragButtons,c[o.zoom],h.onZoomButtonClick,h,d),g=l.tooltipZoom,h.zoomButton.setTooltip(g),h.associate(h.zoomButton,h.zoomButton)),ut.positionDragButtons(e),h.setDragMode(null),e.dragButtons.getNumChildren()>0&&(e.addChild(e.dragButtons),p?_&&(h.panButton.setToggled(!0),h.onPanButtonClick(null)):e.hideDragButtons(),e.dragButtons.setCursor("default"))}else"pan"==u?h.setDragMode(i.DRAG_MODE_PAN):"zoom"==u?h.setDragMode(i.DRAG_MODE_ZOOM):"select"==u?h.setDragMode(i.DRAG_MODE_SELECT):h.setDragMode(i.DRAG_MODE_OFF)}},ut._positionDragButton=function(e,i,r){var a;t.Agent.isRightToLeft(e.getCtx())?(a=r.x+ut._BUTTON_PADDING,r.x+=ut._BUTTON_SIZE+2*ut._BUTTON_PADDING):a=r.x+r.w-ut._BUTTON_SIZE-ut._BUTTON_PADDING,r.w-=ut._BUTTON_SIZE+2*ut._BUTTON_PADDING,i.setTranslate(a,r.y+ut._BUTTON_PADDING)},ut.positionDragButtons=function(t){var e=t.__getPlotAreaSpace().clone();e.x+=ut._BUTTON_CORNER_DIST,e.w-=2*ut._BUTTON_CORNER_DIST,e.y+=ut._BUTTON_CORNER_DIST;var i=t.getEventManager();i.selectButton&&ut._positionDragButton(t,i.selectButton,e),i.panButton&&ut._positionDragButton(t,i.panButton,e),i.zoomButton&&ut._positionDragButton(t,i.zoomButton,e)},ut._createDragButtonBackground=function(e,i){var r=2,a=2,n=t.Agent.isRightToLeft(e);"start"==i?n?r=0:a=0:"end"==i&&(n?a=0:r=0);var s=r,o=a,l=-ut._BUTTON_PADDING,h=ut._BUTTON_SIZE+2*ut._BUTTON_PADDING,u=t.PathUtils.roundedRectangle(l,l,h,h,s,a,o,r),g=new t.Path(e,u);return g.setPixelHinting(t.Agent.getDevicePixelRatio()>1),g},ut._getImageUrl=function(t,e,i,r){var a,n=t.getOptions()._resources[i];return null==n?r:null!=(a=e[n])?a:n},ut._createDragButton=function(e,i,r,a,n,s){var o=e.getCtx(),l=ut._createDragButtonBackground(o,s),h=new t.IconButton(o,"outlined",{style:r,size:ut._BUTTON_SIZE},l,null,a,n);if(t.Agent.isTouchDevice()){var u,g=t.Agent.isRightToLeft(o),d=2*ut._BUTTON_PADDING;(u="solo"==s?new t.Rect(o,-d,-d,ut._BUTTON_SIZE+2*d,ut._BUTTON_SIZE+2*d):"start"==s&&!g||"end"==s&&g?new t.Rect(o,-d,-d,ut._BUTTON_SIZE+1.5*d,ut._BUTTON_SIZE+2*d):new t.Rect(o,-.5*d,-d,ut._BUTTON_SIZE+1.5*d,ut._BUTTON_SIZE+2*d)).setInvisibleFill(),u.setSolidStroke("none"),h.addChild(u)}return h.setToggleEnabled(!0),i.addChild(h),h.addEvtListener(t.MouseEvent.MOUSEDOWN,(function(t){t.stopPropagation()})),h},ut._adjustAvailSpace=function(t){t.x=Math.round(t.x),t.y=Math.round(t.y),t.w=Math.round(t.w),t.h=Math.round(t.h)},ut.renderDataCursor=function(t){var e=null,i=t.getOptions(),r=t.getEventManager();if(rt.isDataCursorEnabled(t)){(e=new w(t.getCtx(),i.styleDefaults.dataCursor,at.isHorizontal(t))).setBehavior(rt.getDataCursorBehavior(t)),t.addChild(e);var a=new l(t,e);r.setDataCursorHandler(a),t.positionDataCursor(i.dataCursorPosition)}else r.setDataCursorHandler(null);return e};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var St=function(t){this.Init(t.getCtx(),t.dispatchEvent,t,t),this._sparkChart=t};t.Obj.createSubclass(St,t.EventManager),St.prototype.ProcessKeyboardEvent=function(e){if(!this.KeyboardHandler)return!1;if(e.keyCode==t.KeyboardEvent.TAB){var i=this._sparkChart.getCtx().getStageAbsolutePosition();this.ProcessObjectTooltip(e,i.x,i.y,this._sparkChart.__getLogicalObject(),this._sparkChart)}return!1},St.prototype.OnBlur=function(t){St.superclass.OnBlur.call(this,t),this.hideTooltip()};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
