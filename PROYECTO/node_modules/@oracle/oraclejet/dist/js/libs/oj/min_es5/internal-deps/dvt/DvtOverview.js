...
/**
   ...
   * @ignore
   */
t.OverviewUtils=new Object,t.OverviewUtils.supportsTouch=function(){return t.Agent.isTouchDevice()},t.Obj.createSubclass(t.OverviewUtils,t.Obj),t.OverviewUtils.getDatePosition=function(t,i,e,n){var o=(e-t)*n,r=i-t;return 0==o||0==r?0:o/r},t.OverviewUtils.getPositionDate=function(t,i,e,n){var o=e*(i-t);return 0==o||0==n?t:o/n+t},
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var i=function t(){this.Init({alta:t.VERSION_1})};t.Obj.createSubclass(i,t.BaseComponentDefaults),i.VERSION_1={overviewPosition:"below",style:{currentTimeIndicatorColor:"#c000d1",handleFillColor:"#ffffff",handleTextureColor:"#b3c6db",leftFilterPanelAlpha:.7,leftFilterPanelColor:"#ffffff",overviewBackgroundColor:"#e6ecf3",rightFilterPanelAlpha:.7,rightFilterPanelColor:"#ffffff",timeAxisBarColor:"#e5e5e5",timeAxisBarAlpha:1,timeIndicatorColor:"#bcc7d2",windowBackgroundAlpha:1,windowBackgroundColor:"#ffffff",windowBorderBottomColor:"#4f4f4f",windowBorderBottomStyle:"solid",windowBorderLeftColor:"#4f4f4f",windowBorderLeftStyle:"solid",windowBorderRightColor:"#4f4f4f",windowBorderRightStyle:"solid",windowBorderTopColor:"#4f4f4f",windowBorderTopStyle:"solid"}},
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
t.OverviewParser=function(t){this.Init(t)},t.Obj.createSubclass(t.OverviewParser,t.Obj),t.OverviewParser.prototype.Init=function(t){this._view=t},t.OverviewParser.prototype.parse=function(t){var i=t;return this.ParseRootAttributes(i)},t.OverviewParser.prototype.ParseRootAttributes=function(i){var e=new Object;return e.animationOnClick=i.animationOnClick,null!=i.xMin&&(e.xMin=i.xMin),null!=i.xMax&&(e.xMax=i.xMax),null!=i.x1&&(e.x1=i.x1),null!=i.x2&&(e.x2=i.x2),null!=i.yMin&&(e.yMin=i.yMin),null!=i.yMax&&(e.yMax=i.yMax),null!=i.y1&&(e.y1=i.y1),null!=i.y2&&(e.y2=i.y2),null!=i.currentTime&&(e.currentTime=i.currentTime),e.orientation="horizontal",null!=i.orientation&&(e.orientation=i.orientation),e.featuresOff=i.featuresOff,e.minimumWindowSize=i.minimumWindowSize,e.leftMargin=i.leftMargin,e.rightMargin=i.rightMargin,e.overviewPosition="below",e.selectionMode="none",e.isRtl=t.Agent.isRightToLeft(this._view.getCtx()).toString(),null!=i.rtl&&(e.isRtl=i.rtl.toString()),e},t.OverviewParser.prototype.calculateWidth=function(t,i,e,n,o){var r=o*(i-t),s=n-e;return 0==r||0==s?0:r/s};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
