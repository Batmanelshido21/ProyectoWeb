...
/**
   ...
   * @ignore
   */
var o=function(t,e){this.Init(t,e)};t.Obj.createSubclass(o,t.Obj),o.prototype.Init=function(t,e){this._displayable=t,this._category=e},o.prototype.getCategories=function(){return this._category},o.prototype.getDisplayables=function(){return[this._displayable]};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
var h=function(t,e,a,i,r){this.Init(t,e,a,i,r)};t.Obj.createSubclass(h,l),h.prototype.Init=function(t,e,a,i,r){h.superclass.Init.call(this,t,e,a,i,null,r)},h.prototype.setAreaLayer=function(t){this._dataAreaLayer=t},h.prototype.setSelected=function(t){this.isSelectable()&&(t&&!this.IsHoverEffectShown()&&this._dataAreaLayer.addChild(this.Displayable),h.superclass.setSelected.call(this,t))},h.prototype.showHoverEffect=function(){this._dataAreaLayer.addChild(this.Displayable),h.superclass.showHoverEffect.call(this)},h.prototype.hideHoverEffect=function(){this.isSelected()?this._dataAreaLayer.addChild(this.Displayable):this._dataAreaLayer.addChildAt(this.Displayable,0),h.superclass.hideHoverEffect.call(this)},h.prototype.HandleZoomEvent=function(t){h.superclass.HandleZoomEvent.call(this,t),this.Displayable.getParent()&&(this.Displayable.handleZoomEvent(t),this.positionLabel(t))},h.prototype.positionLabel=function(t){this.getLabel()&&this.getLabel().update(t)},h.prototype.GetNavigables=function(){return this.getDataLayer().getMap().getNavigableAreas()},h.prototype.animateUpdate=function(t,e){h.superclass.animateUpdate.call(this,t,e),this.getDataLayer().getMapLayer().setAreaRendered(this.getLocation(),!1)},h.prototype.__recenter=function(){};
/**
   * @license
   * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
