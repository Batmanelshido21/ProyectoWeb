 ...
 * http://jquery.org/license
 */
class f{constructor(t){t=t||{},this._textFilterAttributes=t.filterOptions?t.filterOptions.textFilterAttributes:null;let e=t.filterDef;e&&(e.op?(this.op=e.op,e.value?(this.value=e.value,e.attribute&&(this.attribute=e.attribute)):e.criteria&&(this.criteria=e.criteria)):e.text&&(this.text=e.text))}filter(e,r,i){return t.FilterUtils.satisfy(f._transformFilter(this),e)}static _transformFilter(t){let e;if(t){let r,i=t.op;if(t.text?i="$regex":"$le"===i?i="$lte":"$ge"===i?i="$gte":"$pr"===i&&(i="$exists"),"$and"!=i&&"$or"!=i){r=t.text?new RegExp(t.text.replace(/[.*+\-?^${}()|[\]\\]/g,"\\$&"),"i"):t.value,e={};let a=t.attribute;if(a){let t={};"$sw"!==i&&"$ew"!==i&&"$co"!==i||(i="$regex",r=f._fixStringExpr(i,r)),t[i]=r,e[a]=t}else if(t.text){let a={};if(a[i]=r,t._textFilterAttributes&&t._textFilterAttributes.length>0){let r=[];t._textFilterAttributes.forEach((function(t){let e={};e[t]=a,r.push(e)})),e.$or=r}else e["*"]=a}else{let t=[];f._transformObjectExpr(r,i,null,t),e.$and=t}}else{let r=[];t.criteria.forEach((function(t){r.push(f._transformFilter(t))})),e={},e[i]=r}}return e}static _transformObjectExpr(t,e,r,i){if(Object.keys(t).length>0)Object.keys(t).forEach((function(a){let n=t[a],s=r?r+"."+a:a;if(n instanceof Object)f._transformObjectExpr(n,e,s,i);else{let t={};"$sw"!==e&&"$ew"!==e&&"$co"!==e||(e="$regex",n=f._fixStringExpr(e,n)),t[e]=n;let r={};r[s]=t,i.push(r)}}));else{let a={};a[e]=t;let n={};n[r]=a,i.push(n)}}static _fixStringExpr(t,e){return("string"==typeof e||e instanceof String)&&("$sw"===t?e="^"+e:"$ew"===t&&(e+="$")),e}}t.FilterFactory=class{static getFilter(t){return new f(t)}},
/**
 * @preserve Copyright 2013 jQuery Foundation and other contributors
 * Released under the MIT license.
 * http://jquery.org/license
