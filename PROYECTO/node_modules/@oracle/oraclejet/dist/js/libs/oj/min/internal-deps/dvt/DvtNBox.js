 ...
 * @ignore
 */
var r=function(t,e){r.superclass.constructor.call(this,t,e),this._nbox=e};t.Obj.createSubclass(r,t.CategoryRolloverHandler),r.prototype.GetRolloverCallback=function(t,e,n,o){return function(){this.SetHighlightMode(!0),this._nbox.processEvent(t),this._callback&&this._callback.call(this._callbackObj,t,this._source)}.bind(this)},r.prototype.GetRolloutCallback=function(t,e,n,o){return function(){this.SetHighlightModeTimeout(),this._nbox.processEvent(t),this._callback&&this._callback.call(this._callbackObj,t,this._source)}.bind(this)};
/**
 * @license
 * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
 * The Universal Permissive License (UPL), Version 1.0
 ...
 * @ignore
 */
var l=function(t,e,n,o){this.Init(t,e,n,o)};t.Obj.createSubclass(l,t.DataAnimationHandler),l.DELETE=0,l.UPDATE=1,l.INSERT=2,l.prototype.Init=function(t,e,n,o){l.superclass.Init.call(this,t,e),this._oldNBox=n,this._newNBox=o},l.prototype.getOldNBox=function(){return this._oldNBox},l.prototype.getNewNBox=function(){return this._newNBox},l.prototype.getAnimationDuration=function(){return N.getAnimationDuration(this._oldNBox)};
/**
 * @license
 * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
 * The Universal Permissive License (UPL), Version 1.0
 ...
 * @ignore
 */
var g=function(t){this.Init(t.getCtx(),t.processEvent,t,t),this._nbox=t};t.Obj.createSubclass(g,t.EventManager),g.prototype.OnClickInternal=function(t){var e=this.GetLogicalObject(t.target);e instanceof i&&!e.isSelectable()&&e.openDrawer()},g.prototype.OnDblClickInternal=function(t){this._handleDblClick(t.target)},g.prototype.HandleTouchDblClickInternal=function(t){this._handleDblClick(t.target)},g.prototype.HandleTouchClickInternal=function(t){var e=this.GetLogicalObject(t.target);e instanceof i&&!e.isSelectable()&&e.openDrawer()},g.prototype._handleDblClick=function(t){var e=this.GetLogicalObject(t);e&&e.isDoubleClickable&&e.isDoubleClickable()&&e.handleDoubleClick&&e.handleDoubleClick()},g.prototype.ProcessKeyboardEvent=function(e){var n=!1,a=e.keyCode,r=this.getFocus();return a==t.KeyboardEvent.ENTER||a==t.KeyboardEvent.ESCAPE?(r&&r.HandleKeyboardEvent&&r.HandleKeyboardEvent(e),r=null):e.keyCode==t.KeyboardEvent.SPACE&&e.ctrlKey?(r instanceof i||r instanceof o)&&(n=g.superclass.ProcessKeyboardEvent.call(this,e)):n=g.superclass.ProcessKeyboardEvent.call(this,e),n},g.prototype.ProcessRolloverEvent=function(e,n,o){var a=this._nbox.getOptions();if("dim"==a.hoverBehavior){var i=n.getCategories?n.getCategories():[];a.highlightedCategories=o?i.slice():null;var r=t.EventFactory.newCategoryHighlightEvent(a.highlightedCategories,o),s=t.CSSStyle.getTimeMilliseconds(a.styleDefaults.hoverBehaviorDelay);this.RolloverHandler.processEvent(r,this._nbox.getNodeDisplayables(),s,"any"==a.highlightMatch)}},g.prototype.CreateCategoryRolloverHandler=function(t,e){return new r(t,e)},g.prototype.GetTouchResponse=function(){var e=this._nbox.getOptions(),n=_.getDrawer(this._nbox),o=_.getCell(this._nbox,_.getMaximizedCellIndex(this._nbox));return n&&_.getDisplayable(this._nbox,n).getChildContainer().hasScrollingContent()||o&&_.getDisplayable(this._nbox,o).getChildContainer().hasScrollingContent()?t.EventManager.TOUCH_RESPONSE_TOUCH_HOLD:e.touchResponse===t.EventManager.TOUCH_RESPONSE_TOUCH_START?t.EventManager.TOUCH_RESPONSE_TOUCH_START:t.EventManager.TOUCH_RESPONSE_AUTO};
/**
 * @license
 * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
 * The Universal Permissive License (UPL), Version 1.0
 ...
 * @ignore
 */
var f={create:function(t,e){return{x:t,y:e}},add:function(t,e){return f.create(t.x+e.x,t.y+e.y)},subtract:function(t,e){return f.create(t.x-e.x,t.y-e.y)},scale:function(t,e){return f.create(t.x*e,t.y*e)},getMagnitude:function(t){return Math.sqrt(t.x*t.x+t.y*t.y)}};
/**
 * @license
 * Copyright (c) 2014, 2020, Oracle and/or its affiliates.
 * The Universal Permissive License (UPL), Version 1.0
