  ...
  @include module-include-once("common.label") {
    ...
    .oj-label-nocomp.oj-label-nowrap {
        ...
        @include oj-ltr()
        {
            ...
            padding-right: var(--oj-label-inline-gutter);
        ...
        @include oj-rtl()
        {
            ...
            padding-left: var(--oj-label-inline-gutter);
    ...
    .oj-label-required-icon:before {
      content: var(--oj-label-required-char);
    }
    .oj-label-required-icon {
      ...
      font-family: inherit;
      background-color: var(--oj-label-required-icon-background-color);
      border-radius: var(--oj-label-required-icon-border-radius);
      height: var(--oj-label-required-icon-height);
      width: var(--oj-label-required-icon-width);
    }
