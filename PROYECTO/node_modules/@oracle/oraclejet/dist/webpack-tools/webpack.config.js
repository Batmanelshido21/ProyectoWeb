...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'ojs': path.resolve(__dirname, './web/js/libs/oj/v9.2.4/debug'),
      'ojtranslations': path.resolve(__dirname, './web/js/libs/oj/v9.2.4/resources'),
    ...
    new WebpackRequireFixupPlugin(
      {
        ...
        baseResourceUrl: "./web/js/libs/oj/v9.2.4"
      }
    )
