 ...
 * @private
 */
oj.EditableValueUtils._initInputIdLabelForConnection = function (
 ...
 * @private
 */
oj.EditableValueUtils._createOrUpdateReadonlyDiv = function (input, createConditions = true) {
 ...
 */
var BaseInsidelLabelStrategy = function (options) {
  this.Init(options);
};

// Subclass from oj.MessagingStrategy
oj.Object.createSubclass(BaseInsidelLabelStrategy,
  oj.MessagingStrategy, 'BaseInsidelLabelStrategy');
 ...
 */
BaseInsidelLabelStrategy.prototype._createOjLabelElement = function (element, component,
 ...
 * @protected
 */
BaseInsidelLabelStrategy.prototype._CreateEventHandlers = function (span, element,
  ojlabel, component) {
  this._labelHintChangedCallback =
    BaseInsidelLabelStrategy._labelHintChangedHandler.bind(this, span);
  element.addEventListener('labelHintChanged', this._labelHintChangedCallback);
  this._requiredChangedCallback =
  BaseInsidelLabelStrategy._requiredChangedHandler.bind(this, ojlabel, component);
  element.addEventListener('requiredChanged', this._requiredChangedCallback);
  this._helpHintsChangedCallback =
  BaseInsidelLabelStrategy._helpHintsChangedHandler.bind(this, ojlabel, component);
 ...
 * For LabelStrategies this is always only labelEdge.
 */
var InlineHelpHintsStrategy = function (displayOptions, parentElement) {
...
oj.InlineMessagingStrategy.prototype.activate = function (cm) {
  oj.InlineMessagingStrategy.superclass.activate.call(this, cm);
 ...
 * For LabelStrategies this is always only labelEdge.
 */
var InlineRequiredStrategy = function (displayOptions, parentElement) {
  this.Init(displayOptions);
  this._parentElement = parentElement;
};
...
// Subclass from BaseInsidelLabelStrategy
oj.Object.createSubclass(InsideFormControlLabelStrategy,
  BaseInsidelLabelStrategy, 'InsideFormControlLabelStrategy');
...
oj.Object.createSubclass(oj.InsideLabelStrategy,
  BaseInsidelLabelStrategy, 'oj.InsideLabelStrategy');
...
oj.InsideLabelStrategy.prototype._GetFormControlLabelStyleClass = function () {
  ...
  return [oj.InsideLabelStrategy._BASE_STYLE_CLASS,
