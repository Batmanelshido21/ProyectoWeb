...
DataProviderContentHandler.prototype._handleAddTransitionEnd = function (context, elem) {
  ...
  if (this.shouldUseGridRole()) {
    if (!this.isCardLayout()) {
      var firstChild = elem.firstElementChild; // should not be null
...
IteratingDataProviderContentHandler.prototype._isOverflowCheckForCustomScroller = function () {
  ...
  if (scroller !== document.documentElement) {
    var adjustments = this.m_loadingIndicator == null ? 0 : this._getLoadingIndicatorHeight();
    return this.m_root.clientHeight + this._getScrollerOffsetTop() - adjustments > scroller.clientHeight;
...
IteratingDataProviderContentHandler.prototype._checkHorizontalViewport = function () {
  if (this.isCardLayout()) {
    ...
    if (lastItem) {
      ...
      var scrollerHeight = scroller === this.m_root ? this.getRootElementHeight() : scroller.clientHeight;
